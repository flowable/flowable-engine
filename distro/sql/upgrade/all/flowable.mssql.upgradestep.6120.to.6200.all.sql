...
alter table ACT_RU_VARIABLE add SCOPE_ID_ nvarchar(191);
alter table ACT_RU_VARIABLE add SUB_SCOPE_ID_ nvarchar(191);
alter table ACT_RU_VARIABLE add SCOPE_TYPE_ nvarchar(191);
...
alter table ACT_HI_TASKINST add SCOPE_ID_ nvarchar(191);
alter table ACT_HI_TASKINST add SUB_SCOPE_ID_ nvarchar(191);
alter table ACT_HI_TASKINST add SCOPE_TYPE_ nvarchar(191);
alter table ACT_HI_TASKINST add SCOPE_DEFINITION_ID_ nvarchar(191);

create index ACT_IDX_HI_TASK_SCOPE on ACT_HI_TASKINST(SCOPE_ID_, SCOPE_TYPE_);
create index ACT_IDX_HI_TASK_SUB_SCOPE on ACT_HI_TASKINST(SUB_SCOPE_ID_, SCOPE_TYPE_);
create index ACT_IDX_HI_TASK_SCOPE_DEF on ACT_HI_TASKINST(SCOPE_DEFINITION_ID_, SCOPE_TYPE_);
alter table ACT_HI_VARINST add SCOPE_ID_ nvarchar(191);
alter table ACT_HI_VARINST add SUB_SCOPE_ID_ nvarchar(191);
alter table ACT_HI_VARINST add SCOPE_TYPE_ nvarchar(191);
