...
CREATE TABLE act_cmmn_databasechangelog (ID varchar(191) NOT NULL, AUTHOR varchar(191) NOT NULL, FILENAME varchar(191) NOT NULL, DATEEXECUTED TIMESTAMP WITHOUT TIME ZONE NOT NULL, ORDEREXECUTED INTEGER NOT NULL, EXECTYPE VARCHAR(10) NOT NULL, MD5SUM VARCHAR(35), DESCRIPTION varchar(191), COMMENTS varchar(191), TAG varchar(191), LIQUIBASE VARCHAR(20), CONTEXTS varchar(191), LABELS varchar(191), DEPLOYMENT_ID VARCHAR(10));

CREATE TABLE ACT_CMMN_DEPLOYMENT (ID_ varchar(191) NOT NULL, NAME_ varchar(191), CATEGORY_ varchar(191), KEY_ varchar(191), DEPLOY_TIME_ TIMESTAMP WITHOUT TIME ZONE, PARENT_DEPLOYMENT_ID_ varchar(191), TENANT_ID_ varchar(191) DEFAULT '', CONSTRAINT ACT_CMMN_DEPLOYMENT_PKEY PRIMARY KEY (ID_));

CREATE TABLE ACT_CMMN_DEPLOYMENT_RESOURCE (ID_ varchar(191) NOT NULL, NAME_ varchar(191), DEPLOYMENT_ID_ varchar(191), RESOURCE_BYTES_ BYTEA, CONSTRAINT PK_CMMN_DEPLOYMENT_RESOURCE PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RU_CASE_INST (ID_ varchar(191) NOT NULL, REV_ INTEGER NOT NULL, BUSINESS_KEY_ varchar(191), NAME_ varchar(191), PARENT_ID_ varchar(191), CASE_DEF_ID_ varchar(191), STATE_ varchar(191), START_TIME_ TIMESTAMP WITHOUT TIME ZONE, START_USER_ID_ varchar(191), CALLBACK_ID_ varchar(191), CALLBACK_TYPE_ varchar(191), TENANT_ID_ varchar(191) DEFAULT '', CONSTRAINT ACT_CMMN_RU_CASE_INST_PKEY PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RU_SENTRY_PART_INST (ID_ varchar(191) NOT NULL, REV_ INTEGER NOT NULL, CASE_DEF_ID_ varchar(191), CASE_INST_ID_ varchar(191), PLAN_ITEM_INST_ID_ varchar(191), ON_PART_ID_ varchar(191), IF_PART_ID_ varchar(191), TIME_STAMP_ TIMESTAMP WITHOUT TIME ZONE, CONSTRAINT PK_CMMN_SENTRY_PART_INST PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RU_MIL_INST (ID_ varchar(191) NOT NULL, NAME_ varchar(191) NOT NULL, TIME_STAMP_ TIMESTAMP WITHOUT TIME ZONE NOT NULL, CASE_INST_ID_ varchar(191) NOT NULL, CASE_DEF_ID_ varchar(191) NOT NULL, ELEMENT_ID_ varchar(191) NOT NULL, CONSTRAINT ACT_CMMN_RU_MIL_INST_PKEY PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_HI_CASE_INST (ID_ varchar(191) NOT NULL, REV_ INTEGER NOT NULL, BUSINESS_KEY_ varchar(191), NAME_ varchar(191), PARENT_ID_ varchar(191), CASE_DEF_ID_ varchar(191), STATE_ varchar(191), START_TIME_ TIMESTAMP WITHOUT TIME ZONE, END_TIME_ TIMESTAMP WITHOUT TIME ZONE, START_USER_ID_ varchar(191), CALLBACK_ID_ varchar(191), CALLBACK_TYPE_ varchar(191), TENANT_ID_ varchar(191) DEFAULT '', CONSTRAINT ACT_CMMN_HI_CASE_INST_PKEY PRIMARY KEY (ID_));

CREATE TABLE ACT_CMMN_HI_MIL_INST (ID_ varchar(191) NOT NULL, REV_ INTEGER NOT NULL, NAME_ varchar(191) NOT NULL, TIME_STAMP_ TIMESTAMP WITHOUT TIME ZONE NOT NULL, CASE_INST_ID_ varchar(191) NOT NULL, CASE_DEF_ID_ varchar(191) NOT NULL, ELEMENT_ID_ varchar(191) NOT NULL, CONSTRAINT ACT_CMMN_HI_MIL_INST_PKEY PRIMARY KEY (ID_));
...
CREATE TABLE act_co_databasechangelog (ID varchar(191) NOT NULL, AUTHOR varchar(191) NOT NULL, FILENAME varchar(191) NOT NULL, DATEEXECUTED TIMESTAMP WITHOUT TIME ZONE NOT NULL, ORDEREXECUTED INTEGER NOT NULL, EXECTYPE VARCHAR(10) NOT NULL, MD5SUM VARCHAR(35), DESCRIPTION varchar(191), COMMENTS varchar(191), TAG varchar(191), LIQUIBASE VARCHAR(20), CONTEXTS varchar(191), LABELS varchar(191), DEPLOYMENT_ID VARCHAR(10));

CREATE TABLE ACT_CO_CONTENT_ITEM (ID_ varchar(191) NOT NULL, NAME_ varchar(191) NOT NULL, MIME_TYPE_ varchar(191), TASK_ID_ varchar(191), PROC_INST_ID_ varchar(191), CONTENT_STORE_ID_ varchar(191), CONTENT_STORE_NAME_ varchar(191), FIELD_ VARCHAR(400), CONTENT_AVAILABLE_ BOOLEAN DEFAULT FALSE, CREATED_ TIMESTAMP(6) WITHOUT TIME ZONE, CREATED_BY_ varchar(191), LAST_MODIFIED_ TIMESTAMP(6) WITHOUT TIME ZONE, LAST_MODIFIED_BY_ varchar(191), CONTENT_SIZE_ BIGINT DEFAULT 0, TENANT_ID_ varchar(191), CONSTRAINT ACT_CO_CONTENT_ITEM_PKEY PRIMARY KEY (ID_));
