...
CREATE TABLE ACT_CMMN_DATABASECHANGELOG (ID varchar(191) NOT NULL, AUTHOR varchar(191) NOT NULL, FILENAME varchar(191) NOT NULL, DATEEXECUTED datetime NOT NULL, ORDEREXECUTED INT NOT NULL, EXECTYPE VARCHAR(10) NOT NULL, MD5SUM VARCHAR(35) NULL, DESCRIPTION varchar(191) NULL, COMMENTS varchar(191) NULL, TAG varchar(191) NULL, LIQUIBASE VARCHAR(20) NULL, CONTEXTS varchar(191) NULL, LABELS varchar(191) NULL, DEPLOYMENT_ID VARCHAR(10) NULL);

CREATE TABLE ACT_CMMN_DEPLOYMENT (ID_ varchar(191) NOT NULL, NAME_ varchar(191) NULL, CATEGORY_ varchar(191) NULL, KEY_ varchar(191) NULL, DEPLOY_TIME_ datetime NULL, PARENT_DEPLOYMENT_ID_ varchar(191) NULL, TENANT_ID_ varchar(191) DEFAULT '' NULL, CONSTRAINT PK_ACT_CMMN_DEPLOYMENT PRIMARY KEY (ID_));

CREATE TABLE ACT_CMMN_DEPLOYMENT_RESOURCE (ID_ varchar(191) NOT NULL, NAME_ varchar(191) NULL, DEPLOYMENT_ID_ varchar(191) NULL, RESOURCE_BYTES_ LONGBLOB NULL, CONSTRAINT PK_CMMN_DEPLOYMENT_RESOURCE PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_CASEDEF (ID_ varchar(191) NOT NULL, REV_ INT NOT NULL, NAME_ varchar(191) NULL, KEY_ varchar(191) NOT NULL, VERSION_ INT NOT NULL, CATEGORY_ varchar(191) NULL, DEPLOYMENT_ID_ varchar(191) NULL, RESOURCE_NAME_ VARCHAR(4000) NULL, DESCRIPTION_ VARCHAR(4000) NULL, HAS_GRAPHICAL_NOTATION_ BIT(1) NULL, TENANT_ID_ varchar(191) DEFAULT '' NULL, CONSTRAINT PK_ACT_CMMN_CASEDEF PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RU_CASE_INST (ID_ varchar(191) NOT NULL, REV_ INT NOT NULL, BUSINESS_KEY_ varchar(191) NULL, NAME_ varchar(191) NULL, PARENT_ID_ varchar(191) NULL, CASE_DEF_ID_ varchar(191) NULL, STATE_ varchar(191) NULL, START_TIME_ datetime NULL, START_USER_ID_ varchar(191) NULL, CALLBACK_ID_ varchar(191) NULL, CALLBACK_TYPE_ varchar(191) NULL, TENANT_ID_ varchar(191) DEFAULT '' NULL, CONSTRAINT PK_ACT_CMMN_RU_CASE_INST PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RU_PLAN_ITEM_INST (ID_ varchar(191) NOT NULL, REV_ INT NOT NULL, CASE_DEF_ID_ varchar(191) NULL, CASE_INST_ID_ varchar(191) NULL, STAGE_INST_ID_ varchar(191) NULL, IS_STAGE_ BIT(1) NULL, ELEMENT_ID_ varchar(191) NULL, NAME_ varchar(191) NULL, STATE_ varchar(191) NULL, START_TIME_ datetime NULL, START_USER_ID_ varchar(191) NULL, REFERENCE_ID_ varchar(191) NULL, REFERENCE_TYPE_ varchar(191) NULL, TENANT_ID_ varchar(191) DEFAULT '' NULL, CONSTRAINT PK_CMMN_PLAN_ITEM_INST PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RU_SENTRY_PART_INST (ID_ varchar(191) NOT NULL, REV_ INT NOT NULL, CASE_DEF_ID_ varchar(191) NULL, CASE_INST_ID_ varchar(191) NULL, PLAN_ITEM_INST_ID_ varchar(191) NULL, ON_PART_ID_ varchar(191) NULL, IF_PART_ID_ varchar(191) NULL, TIME_STAMP_ datetime NULL, CONSTRAINT PK_CMMN_SENTRY_PART_INST PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RU_MIL_INST (ID_ varchar(191) NOT NULL, NAME_ varchar(191) NOT NULL, TIME_STAMP_ datetime NOT NULL, CASE_INST_ID_ varchar(191) NOT NULL, CASE_DEF_ID_ varchar(191) NOT NULL, ELEMENT_ID_ varchar(191) NOT NULL, CONSTRAINT PK_ACT_CMMN_RU_MIL_INST PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_HI_CASE_INST (ID_ varchar(191) NOT NULL, REV_ INT NOT NULL, BUSINESS_KEY_ varchar(191) NULL, NAME_ varchar(191) NULL, PARENT_ID_ varchar(191) NULL, CASE_DEF_ID_ varchar(191) NULL, STATE_ varchar(191) NULL, START_TIME_ datetime NULL, END_TIME_ datetime NULL, START_USER_ID_ varchar(191) NULL, CALLBACK_ID_ varchar(191) NULL, CALLBACK_TYPE_ varchar(191) NULL, TENANT_ID_ varchar(191) DEFAULT '' NULL, CONSTRAINT PK_ACT_CMMN_HI_CASE_INST PRIMARY KEY (ID_));

CREATE TABLE ACT_CMMN_HI_MIL_INST (ID_ varchar(191) NOT NULL, REV_ INT NOT NULL, NAME_ varchar(191) NOT NULL, TIME_STAMP_ datetime NOT NULL, CASE_INST_ID_ varchar(191) NOT NULL, CASE_DEF_ID_ varchar(191) NOT NULL, ELEMENT_ID_ varchar(191) NOT NULL, CONSTRAINT PK_ACT_CMMN_HI_MIL_INST PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_HI_PLAN_ITEM_INST (ID_ varchar(191) NOT NULL, REV_ INT NOT NULL, NAME_ varchar(191) NULL, STATE_ varchar(191) NULL, CASE_DEF_ID_ varchar(191) NULL, CASE_INST_ID_ varchar(191) NULL, STAGE_INST_ID_ varchar(191) NULL, IS_STAGE_ BIT(1) NULL, ELEMENT_ID_ varchar(191) NULL, ITEM_DEFINITION_ID_ varchar(191) NULL, ITEM_DEFINITION_TYPE_ varchar(191) NULL, CREATED_TIME_ datetime NULL, LAST_AVAILABLE_TIME_ datetime NULL, LAST_ENABLED_TIME_ datetime NULL, LAST_DISABLED_TIME_ datetime NULL, LAST_STARTED_TIME_ datetime NULL, LAST_SUSPENDED_TIME_ datetime NULL, COMPLETED_TIME_ datetime NULL, OCCURRED_TIME_ datetime NULL, TERMINATED_TIME_ datetime NULL, EXIT_TIME_ datetime NULL, ENDED_TIME_ datetime NULL, LAST_UPDATED_TIME_ datetime NULL, START_USER_ID_ varchar(191) NULL, REFERENCE_ID_ varchar(191) NULL, REFERENCE_TYPE_ varchar(191) NULL, TENANT_ID_ varchar(191) DEFAULT '' NULL, CONSTRAINT PK_ACT_CMMN_HI_PLAN_ITEM_INST PRIMARY KEY (ID_));

ALTER TABLE ACT_CMMN_RU_MIL_INST ADD TENANT_ID_ varchar(191) DEFAULT '' NULL;

ALTER TABLE ACT_CMMN_HI_MIL_INST ADD TENANT_ID_ varchar(191) DEFAULT '' NULL;
...
CREATE TABLE ACT_CO_DATABASECHANGELOG (ID varchar(191) NOT NULL, AUTHOR varchar(191) NOT NULL, FILENAME varchar(191) NOT NULL, DATEEXECUTED datetime NOT NULL, ORDEREXECUTED INT NOT NULL, EXECTYPE VARCHAR(10) NOT NULL, MD5SUM VARCHAR(35) NULL, DESCRIPTION varchar(191) NULL, COMMENTS varchar(191) NULL, TAG varchar(191) NULL, LIQUIBASE VARCHAR(20) NULL, CONTEXTS varchar(191) NULL, LABELS varchar(191) NULL, DEPLOYMENT_ID VARCHAR(10) NULL);

CREATE TABLE ACT_CO_CONTENT_ITEM (ID_ varchar(191) NOT NULL, NAME_ varchar(191) NOT NULL, MIME_TYPE_ varchar(191) NULL, TASK_ID_ varchar(191) NULL, PROC_INST_ID_ varchar(191) NULL, CONTENT_STORE_ID_ varchar(191) NULL, CONTENT_STORE_NAME_ varchar(191) NULL, FIELD_ VARCHAR(400) NULL, CONTENT_AVAILABLE_ BIT(1) DEFAULT 0 NULL, CREATED_ timestamp(6) NULL, CREATED_BY_ varchar(191) NULL, LAST_MODIFIED_ timestamp(6) NULL, LAST_MODIFIED_BY_ varchar(191) NULL, CONTENT_SIZE_ BIGINT DEFAULT 0 NULL, TENANT_ID_ varchar(191) NULL, CONSTRAINT PK_ACT_CO_CONTENT_ITEM PRIMARY KEY (ID_));
...
ALTER TABLE ACT_CO_CONTENT_ITEM ADD SCOPE_ID_ varchar(191) NULL, ADD SCOPE_TYPE_ varchar(191) NULL;
