...
Flowable is a fork of Activiti (registered trademark by Alfresco). In the all the following sections you’ll notice that the package names, configuration files, etc. use _activiti_.
