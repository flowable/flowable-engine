...
In reality, this logic could be anything ranging from doing an HTTP REST call to some system or to doing some legacy code calls to a system the company has
