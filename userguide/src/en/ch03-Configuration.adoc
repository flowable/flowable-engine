...
|PROCESS_CANCELLED|A process has been canceled. Dispatched before the process instance is deleted from runtime. Process instance is canceled by API call +RuntimeService.deleteProcessInstance+|+org.flowable...FlowableCancelledEvent+
