...
The distribution contains most of the sources as jar files. The source code of Flowable can be found on
  link:$$https://github.com/flowable/flowable-engine/tree/flowable-5.22.0-dev$$[https://github.com/flowable/flowable-engine/tree/flowable-5.22.0-dev].
...
After you've done that you can post questions and comments on link:$$http://forum.flowable.org$$[the Users forum] and create issues in link:$$https://github.com/flowable/flowable-engine/issues$$[our Github issue tracker].
