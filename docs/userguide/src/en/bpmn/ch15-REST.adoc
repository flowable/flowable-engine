...
You can activate the alternative behavior with the scope that is applied to variables REST. It is activated by setting the variable withScopedVariables of the ActionRequest class to true.
