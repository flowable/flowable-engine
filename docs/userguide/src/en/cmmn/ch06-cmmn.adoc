...
Plan items on the case model can have a _manual activation rule_, an expression that can be used to indicate a certain plan item needs need to be _manually activated by an end-user_.
