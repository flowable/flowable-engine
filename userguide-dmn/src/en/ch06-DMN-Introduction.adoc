...
In this example the expression ' == "BRONZE" ' is entered. Combined the variable defined in the corresponding input expression (column header) this will result during runtime in the full expression ' customerCat == "BRONZE" '.
...
[source,xml,linenums]
----
<definitions xmlns="http://www.omg.org/spec/DMN/20151130" id="definition_052249e2-f35d-11e6-9c45-0242ac120005" name="Determine Discount" namespace="http://www.flowable.org/dmn">
