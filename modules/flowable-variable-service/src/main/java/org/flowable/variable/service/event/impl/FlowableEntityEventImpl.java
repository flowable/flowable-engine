 ...
 */
public class FlowableEntityEventImpl extends FlowableEventImpl implements FlowableVariableServiceEntityEvent {

    protected Object entity;

    public FlowableEntityEventImpl(Object entity, FlowableVariableServiceEventType type) {
        super(type);
        if (entity == null) {
