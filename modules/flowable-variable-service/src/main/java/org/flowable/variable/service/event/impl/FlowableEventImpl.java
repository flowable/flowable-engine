...
public class FlowableEventImpl implements FlowableEvent {
    ...
    protected FlowableVariableServiceEventType type;
     ...
     */
    public FlowableEventImpl(FlowableVariableServiceEventType type) {
     ...
     */
    public FlowableEventImpl(FlowableVariableServiceEventType type, String executionId, String processInstanceId, String processDefinitionId) {
        if (type == null) {
    ...
    public FlowableVariableServiceEventType getType() {
        return type;
    }

    public void setType(FlowableVariableServiceEventType type) {
        this.type = type;
    }
