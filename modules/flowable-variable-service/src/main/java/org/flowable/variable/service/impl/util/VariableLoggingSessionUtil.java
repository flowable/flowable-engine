...
public class VariableLoggingSessionUtil {
    ...
    public static void addVariableValue(Object variableValue, String variableTypeName, String variableRawValueName, String variableValueName, ObjectNode loggingNode) {
        ...
        } else if (InstantType.TYPE_NAME.equals(variableTypeName) || JodaDateTimeType.TYPE_NAME.equals(variableTypeName)) {
            loggingNode.put(variableRawValueName, LoggingSessionUtil.formatDate((Instant) variableValue));
        } else if (LocalDateType.TYPE_NAME.equals(variableTypeName) || JodaDateType.TYPE_NAME.equals(variableTypeName)) {
