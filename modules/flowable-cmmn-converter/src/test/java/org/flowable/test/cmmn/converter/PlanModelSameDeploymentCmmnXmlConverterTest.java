 ...
 */
public class PlanModelSameDeploymentCmmnXmlConverterTest extends AbstractConverterTest {

    private static final String CMMN_RESOURCE = "org/flowable/test/cmmn/converter/planModelSameDeployment.cmmn";
    ...
    public void validateModel(CmmnModel cmmnModel) {
        ...
        assertThat(planModel.getFormKey()).isEqualTo("testForm");
