...
public class ContentItemCollectionResource extends ContentItemBaseResource {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "createdOn", dataType = "string", value = "Only return content items with the given create date.", paramType = "query"),
            @ApiImplicitParam(name = "createdBefore", dataType = "string", value = "Only return content items before given create date.", paramType = "query"),
            @ApiImplicitParam(name = "createdAfter", dataType = "string", value = "Only return content items after given create date.", paramType = "query"),
            ...
            @ApiImplicitParam(name = "lastModifiedOn", dataType = "string", value = "Only return content items with the given last modified date.", paramType = "query"),
            @ApiImplicitParam(name = "lastModifiedBefore", dataType = "string", value = "Only return content items before given last modified date.", paramType = "query"),
            @ApiImplicitParam(name = "lastModifiedAfter", dataType = "string", value = "Only return content items after given last modified date.", paramType = "query"),
