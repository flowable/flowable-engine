...
public class CasePageTaskParseHandler extends AbstractPlanItemParseHandler<CasePageTask> {
    ...
    @Override
    protected void executePlanItemParse(CmmnParserImpl cmmnParser, CmmnParseResult cmmnParseResult, PlanItem planItem, CasePageTask casePageTask) {
        planItem.setBehavior(cmmnParser.getActivityBehaviorFactory().createCasePageTaskActivityBehaviour(planItem, casePageTask));
    }
