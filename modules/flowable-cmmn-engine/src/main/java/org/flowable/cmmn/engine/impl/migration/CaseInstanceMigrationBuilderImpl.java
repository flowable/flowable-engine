...
public class CaseInstanceMigrationBuilderImpl implements CaseInstanceMigrationBuilder {
    ...
    public CaseInstanceMigrationBuilder fromCaseInstanceMigrationDocument(CaseInstanceMigrationDocument caseInstanceMigrationDocument) {
        ...
        this.caseInstanceMigrationDocumentDocumentBuilder.addPlanItemMigrationMappings(caseInstanceMigrationDocument.getPlanItemMigrationMappings());
    ...
    @Override
    public CaseInstanceMigrationBuilder addActivityMigrationMapping(PlanItemMigrationMapping mapping) {
        this.caseInstanceMigrationDocumentDocumentBuilder.addPlanItemMigrationMapping(mapping);
        return this;
    }
