 ...
 * @author Javier Casal
 */
public class GetHistoricEntityLinkParentForCaseInstanceCmd implements Command<List<HistoricEntityLink>>, Serializable {

    private static final long serialVersionUID = 1L;
    protected String caseInstanceId;

    public GetHistoricEntityLinkParentForCaseInstanceCmd(String caseInstanceId) {
