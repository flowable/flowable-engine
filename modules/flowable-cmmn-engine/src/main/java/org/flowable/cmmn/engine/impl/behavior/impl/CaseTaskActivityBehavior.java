...
public class CaseTaskActivityBehavior extends TaskActivityBehavior implements PlanItemActivityBehavior {
    ...
    public void execute(CommandContext commandContext, PlanItemInstanceEntity planItemInstanceEntity) {
        ...
        caseInstanceEntity.setCallbackType(CallbackType.PLAN_ITEM_CHILD_CASE);
        caseInstanceEntity.setCallbackId(planItemInstanceEntity.getId());

        planItemInstanceEntity.setReferenceType(CallbackType.PLAN_ITEM_CHILD_CASE);
    ...
    public void trigger(CommandContext commandContext, PlanItemInstanceEntity planItemInstance) {
        ...
        if (!CallbackType.PLAN_ITEM_CHILD_CASE.equals(planItemInstance.getReferenceType())) {
