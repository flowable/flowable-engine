...
public interface CmmnActivityBehaviorFactory {
    ...
    ReactivateEventListenerActivityBehaviour createReactivateEventListenerActivityBehavior(PlanItem planItem, ReactivateEventListener reactivateEventListener);
