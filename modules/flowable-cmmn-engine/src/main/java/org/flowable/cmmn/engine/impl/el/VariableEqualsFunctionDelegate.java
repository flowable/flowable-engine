...
public class VariableEqualsFunctionDelegate implements FlowableFunctionDelegate {
    ...
    static {
        try {
            METHOD = ElVariablesUtil.class.getDeclaredMethod("equals", PlanItemInstance.class, Object.class, Object.class);
        } catch (Exception e) {
            LOGGER.error("Can't find correct equals method on " + ElVariablesUtil.class, e);
        }
    }
