...
public class SetCaseInstanceInProgressStartTimeCmd implements Command<Void>, Serializable {
    ...
    public SetCaseInstanceInProgressStartTimeCmd(String caseInstanceId, String userId) {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        caseInstanceEntityManager.updateCaseInstanceInProgressStartTime(caseInstanceEntity, cmmnEngineConfiguration.getClock().getCurrentTime(), userId);
