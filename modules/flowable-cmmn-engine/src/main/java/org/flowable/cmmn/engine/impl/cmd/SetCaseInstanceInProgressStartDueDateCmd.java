...
public class SetCaseInstanceInProgressStartDueDateCmd implements Command<Void>, Serializable {
    ...
    public SetCaseInstanceInProgressStartDueDateCmd(String caseInstanceId, Date inProgressStartDueDate) {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        caseInstanceEntityManager.updateCaseInstanceInProgressStartDueDate(caseInstanceEntity, inProgressStartDueDate);
