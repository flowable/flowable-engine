...
public class ProcessTaskActivityBehavior extends TaskActivityBehavior implements PlanItemActivityBehavior {
    ...
    public void execute(CommandContext commandContext, PlanItemInstanceEntity planItemInstanceEntity) {
        ...
        planItemInstanceEntity.setReferenceType(CallbackType.PLAN_ITEM_CHILD_PROCESS);
    ...
    public void trigger(CommandContext commandContext, PlanItemInstanceEntity planItemInstance) {
        ...
        if (!CallbackType.PLAN_ITEM_CHILD_PROCESS.equals(planItemInstance.getReferenceType())) {
