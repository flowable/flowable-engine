...
CREATE TABLE DATABASECHANGELOG (ID varchar(191) NOT NULL, AUTHOR varchar(191) NOT NULL, FILENAME varchar(191) NOT NULL, DATEEXECUTED TIMESTAMP NOT NULL, ORDEREXECUTED INTEGER NOT NULL, EXECTYPE VARCHAR(10) NOT NULL, MD5SUM VARCHAR(35), DESCRIPTION varchar(191), COMMENTS varchar(191), TAG varchar(191), LIQUIBASE VARCHAR(20), CONTEXTS varchar(191), LABELS varchar(191), DEPLOYMENT_ID VARCHAR(10));

CREATE TABLE ACT_CMMN_RE_DEPLOYMENT (ID_ varchar(191) NOT NULL, NAME_ varchar(191), CATEGORY_ varchar(191), DEPLOY_TIME_ TIMESTAMP, PARENT_DEPLOYMENT_ID_ varchar(191), TENANT_ID_ varchar(191), CONSTRAINT PK_ACT_CMMN_RE_DE PRIMARY KEY (ID_));

CREATE TABLE ACT_CMMN_RE_DEPLOYMENT_RESOURCE (ID_ varchar(191) NOT NULL, NAME_ varchar(191), DEPLOYMENT_ID_ varchar(191), RESOURCE_BYTES_ BLOB, CONSTRAINT PK_ACT_CMMN_RE_DE PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RE_CASEDEF (ID_ varchar(191) NOT NULL, REV_ INTEGER NOT NULL, NAME_ varchar(191), KEY_ varchar(191) NOT NULL, VERSION_ varchar(191) NOT NULL, CATEGORY_ varchar(191), DEPLOYMENT_ID_ varchar(191), RESOURCE_NAME_ VARCHAR(4000), DESCRIPTION_ VARCHAR(4000), HAS_GRAPHICAL_NOTATION_ SMALLINT, TENANT_ID_ varchar(191) DEFAULT '' NOT NULL, CONSTRAINT PK_ACT_CMMN_RE_CA PRIMARY KEY (ID_));
...
CREATE TABLE ACT_CMMN_RU_SENTRY_ON_PART_INST (ID_ varchar(191) NOT NULL, REV_ INTEGER NOT NULL, CASE_DEF_ID_ varchar(191), CASE_INST_ID_ varchar(191), PLAN_ITEM_INST_ID_ varchar(191), ON_PART_ID_ varchar(191), TIME_STAMP_ TIMESTAMP, CONSTRAINT PK_ACT_CMMN_RU_SE PRIMARY KEY (ID_));
