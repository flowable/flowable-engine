...
public abstract class ProcessLevelValidator extends ValidatorImpl {
    ...
    public void validate(BpmnModel bpmnModel, ProcessValidationContext validationContext) {
        for (Process process : bpmnModel.getProcesses()) {
            executeValidation(bpmnModel, process, validationContext);
        }
    }

    protected abstract void executeValidation(BpmnModel bpmnModel, Process process, ProcessValidationContext validationContext);
