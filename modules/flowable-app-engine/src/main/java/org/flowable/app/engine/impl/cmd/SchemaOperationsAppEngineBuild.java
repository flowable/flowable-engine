...
public class SchemaOperationsAppEngineBuild implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        AppEngineConfiguration engineConfiguration = CommandContextUtil.getAppEngineConfiguration(commandContext);
        String databaseSchemaUpdate = engineConfiguration.getDatabaseSchemaUpdate();
        ((AppDbSchemaManager) engineConfiguration.getSchemaManager()).initSchema(databaseSchemaUpdate);
