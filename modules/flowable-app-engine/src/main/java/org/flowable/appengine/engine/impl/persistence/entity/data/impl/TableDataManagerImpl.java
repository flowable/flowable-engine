 ...
 */
package org.flowable.appengine.engine.impl.persistence.entity.data.impl;
...
import org.flowable.appengine.engine.impl.persistence.entity.AppResourceEntity;
...
public class TableDataManagerImpl implements TableDataManager {
    ...
    public Map<String, Long> getTableCount() {
        ...
        for (String table : getTablesPresentInDatabase()) {
            counts.put(table, (Long) CommandContextUtil.getDbSqlSession().selectOne("org.flowable.appengine.engine.impl.TableData.selectTableCount", table));
        }
        return counts;
    }
