 ...
 */
package org.flowable.appengine.engine;
...
import org.flowable.appengine.api.AppEngineConfigurationApi;
import org.flowable.appengine.api.AppManagementService;
import org.flowable.appengine.api.AppRepositoryService;
import org.flowable.appengine.api.repository.AppResourceConverter;
...
import org.flowable.appengine.engine.impl.db.EntityDependencyOrder;
import org.flowable.appengine.engine.impl.deployer.AppDeployer;
import org.flowable.appengine.engine.impl.deployer.AppDeploymentManager;
import org.flowable.appengine.engine.impl.deployer.AppResourceConverterImpl;
import org.flowable.appengine.engine.impl.el.AppExpressionManager;
import org.flowable.appengine.engine.impl.interceptor.AppCommandInvoker;
import org.flowable.appengine.engine.impl.persistence.entity.AppDefinitionEntityManager;
import org.flowable.appengine.engine.impl.persistence.entity.AppDefinitionEntityManagerImpl;
import org.flowable.appengine.engine.impl.persistence.entity.AppDeploymentEntityManager;
import org.flowable.appengine.engine.impl.persistence.entity.AppDeploymentEntityManagerImpl;
import org.flowable.appengine.engine.impl.persistence.entity.AppResourceEntityManager;
import org.flowable.appengine.engine.impl.persistence.entity.AppResourceEntityManagerImpl;
import org.flowable.appengine.engine.impl.persistence.entity.data.AppDefinitionDataManager;
import org.flowable.appengine.engine.impl.persistence.entity.data.AppDeploymentDataManager;
import org.flowable.appengine.engine.impl.persistence.entity.data.AppResourceDataManager;
import org.flowable.appengine.engine.impl.persistence.entity.data.TableDataManager;
import org.flowable.appengine.engine.impl.persistence.entity.data.impl.MybatisAppDefinitionDataManager;
import org.flowable.appengine.engine.impl.persistence.entity.data.impl.MybatisAppDeploymentDataManager;
import org.flowable.appengine.engine.impl.persistence.entity.data.impl.MybatisResourceDataManager;
import org.flowable.appengine.engine.impl.persistence.entity.data.impl.TableDataManagerImpl;
import org.flowable.appengine.engine.impl.persistence.entity.deploy.AppDefinitionCacheEntry;
...
public class AppEngineConfiguration extends AbstractEngineConfiguration implements AppEngineConfigurationApi {
    ...
    public static final String DEFAULT_MYBATIS_MAPPING_FILE = "org/flowable/appengine/db/mapping/mappings.xml";
