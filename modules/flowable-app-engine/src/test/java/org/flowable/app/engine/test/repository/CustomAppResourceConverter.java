...
public class CustomAppResourceConverter implements AppResourceConverter {

    protected ObjectMapper objectMapper;

    public CustomAppResourceConverter(ObjectMapper objectMapper) {
    ...
    public AppModel convertAppResourceToModel(byte[] appResourceBytes) {
        AppModel appModel;
        try {
            appModel = objectMapper.readValue(appResourceBytes, CustomAppModel.class);
        } catch (Exception e) {
