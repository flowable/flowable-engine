 ...
 * 
 *   &#64;Rule
 *   public ActivitiContentRule activitiContentRule = new ActivitiContentRule();
 *   
 *   ...
 * }
 * </pre>
 ...
 * 
 * <p>
 * The activitiRule also lets you {@link ActivitiContentRule#setCurrentTime(Date) set the current time used by the process engine}. This can be handy to control the exact time that is used by the engine
 ...
 */
public class ActivitiContentRule implements TestRule {

  protected String configurationResource = "activiti.content.cfg.xml";
  ...
  public ActivitiContentRule() {
  }

  public ActivitiContentRule(String configurationResource) {
    this.configurationResource = configurationResource;
  }

  public ActivitiContentRule(ContentEngine contentEngine) {
