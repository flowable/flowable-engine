 ...
 * 
 * <p>
 * The DmnEngine and the services will be made available to the test class through the getters of the FlowableContentRule. The dmnEngine will be initialized by default with the activiti.dmn.cfg.xml resource
 ...
 * 
 * <p>
 * The activitiRule also lets you {@link FlowableContentRule#setCurrentTime(Date) set the current time used by the process engine}. This can be handy to control the exact time that is used by the engine
