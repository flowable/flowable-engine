 ...
 */
package org.flowable.content.engine.impl.persistence.tenant;
 ...
 */
public class ContentMyBatisChangeTenantIdManager implements ChangeTenantIdManager {

    protected final CommandExecutor commandExecutor;

    public ContentMyBatisChangeTenantIdManager(CommandExecutor commandExecutor) {
    ...
    public ChangeTenantIdResult simulate(ChangeTenantIdRequest request) {
        return commandExecutor.execute(
                new SimulateChangeTenantIdCmd(request, "content", Collections.singleton(ContentChangeTenantIdEntityTypes.CONTENT_ITEM_INSTANCES)));
    }

    @Override
    public ChangeTenantIdResult complete(ChangeTenantIdRequest request) {
        return commandExecutor.execute(
                new ExecuteChangeTenantIdCmd(request, "content", Collections.singleton(ContentChangeTenantIdEntityTypes.CONTENT_ITEM_INSTANCES)));
    }
