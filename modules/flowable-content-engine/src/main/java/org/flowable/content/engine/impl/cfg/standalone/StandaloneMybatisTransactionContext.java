 ...
 */
package org.flowable.content.engine.impl.cfg.standalone;
 ...
 public void commit() {
  ...
  protected void fireTransactionEvent(TransactionState transactionState, boolean executeInNewContext) {
    ...
    if (executeInNewContext) {
      CommandExecutor commandExecutor = commandContext.getContentEngineConfiguration().getCommandExecutor(); 
