 ...
 * <ol>
 * <li>If the file <code>JAVA_HOME/lib/el.properties</code> exists and if it contains property <code>javax.el.ExpressionFactory</code> whose value is the name of this class, these properties are taken
 * as default properties.</li>
 * <li>Otherwise, if system property <code>javax.el.ExpressionFactory</code> is set to the name of this class, the system properties {@link System#getProperties()} are taken as default properties.
 * </li>
 * <li><code>el.properties</code> on your classpath. These properties override the properties from <code>JAVA_HOME/lib/el.properties</code> or {@link System#getProperties()}.</li>
 * </ol>
 ...
 * <li><code>javax.el.methodInvocations</code> - allow method invocations as in <code>${foo.bar(baz)}</code> (boolean, default is <code>false</code>).</li>
 * <li><code>javax.el.nullProperties</code> - resolve <code>null</code> properties as in <code>${foo[null]}</code> (boolean, default is <code>false</code>).</li>
 * <li><code>javax.el.varArgs</code> - support function/method calls using varargs (boolean, default is <code>false</code>).</li>
 * </ul>
 * 
...
public class ExpressionFactoryImpl extends ExpressionFactory {
    ...
    /**
     * Create a new expression factory using the default builder and cache implementations. The builder and cache are configured from <code>el.properties</code> (see above). The maximum cache size
     * will be 1000 unless overridden in <code>el.properties</code>. The builder profile is {@link Profile#JEE6} (features may be overridden in <code>el.properties</code>).
     */
