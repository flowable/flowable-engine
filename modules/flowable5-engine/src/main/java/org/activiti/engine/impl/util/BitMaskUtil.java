 ...
 * 
 * Currently, only 8-bits are supported, but can be extended to use all
...
public class BitMaskUtil {
  ...
  // First 8 masks as constant to prevent having to math.pow() every time a bit needs flipping.
