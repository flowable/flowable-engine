...
public abstract class MethodExpression extends Expression {
    ...
    /**
     * If a String literal is specified as the expression, returns the String literal coerced to the expected return type of the method signature. An ELException is thrown if expectedReturnType is
     * void or if the coercion of the String literal to the expectedReturnType yields an error (see Section "1.16 Type Conversion" of the EL specification). If not a String literal, evaluates the
     * expression relative to the provided context, invokes the method that was found using the supplied parameters, and returns the result of the method invocation. Any parameters passed to this
     * method is ignored if isLiteralText() is true.
     * 
     * @param context
     *            The context of this evaluation.
     * @param params
     ...
     *             if no suitable method can be found.
     * @throws ELException
     *             if a String literal is specified and expectedReturnType of the MethodExpression is void or if the coercion of the String literal to the expectedReturnType yields an error (see
