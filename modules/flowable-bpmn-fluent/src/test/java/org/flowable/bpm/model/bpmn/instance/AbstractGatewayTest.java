...
public abstract class AbstractGatewayTest<G extends Gateway>
    ...
    public void getGateway() {
        InputStream inputStream = ReflectUtil.getResourceAsStream("org/flowable/bpm/model/bpmn/GatewaysTest.xml");
        Collection<ModelElementInstance> elementInstances = BpmnModelBuilder.readModelFromStream(inputStream).getModelElementsByType(modelElementType);
