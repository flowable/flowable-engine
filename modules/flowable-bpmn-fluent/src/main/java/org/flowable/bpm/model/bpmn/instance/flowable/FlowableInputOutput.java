 ...
 */
public interface FlowableInputOutput
        extends BpmnModelElementInstance {

    Collection<FlowableInputParameter> getFlowableInputParameters();

    Collection<FlowableOutputParameter> getFlowableOutputParameters();
