...
import static org.flowable.bpm.model.bpmn.impl.BpmnModelConstants.FLOWABLE_ELEMENT_VALUE;
...
/**
 * The BPMN value Flowable extension element.
 */
public class FlowableValueImpl
        extends BpmnModelElementInstanceImpl
        implements FlowableValue {

    protected static Attribute<String> flowableIdAttribute;
    protected static Attribute<String> flowableNameAttribute;

    public static void registerType(ModelBuilder modelBuilder) {
        ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FlowableValue.class, FLOWABLE_ELEMENT_VALUE)
                .namespaceUri(FLOWABLE_NS)
                .instanceProvider(new ModelTypeInstanceProvider<FlowableValue>() {
                    @Override
                    public FlowableValue newInstance(ModelTypeInstanceContext instanceContext) {
                        return new FlowableValueImpl(instanceContext);
                    }
                });
    ...
    public FlowableValueImpl(ModelTypeInstanceContext instanceContext) {
