...
import static org.flowable.bpm.model.bpmn.impl.BpmnModelConstants.FLOWABLE_ELEMENT_ENTRY;
...
public class FlowableEntryImpl
        extends FlowableGenericValueElementImpl
        implements FlowableEntry {
    ...
    public FlowableEntryImpl(ModelTypeInstanceContext instanceContext) {
