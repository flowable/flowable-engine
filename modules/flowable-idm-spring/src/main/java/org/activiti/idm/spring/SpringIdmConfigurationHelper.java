...
public class SpringIdmConfigurationHelper {
  ...
  public static IdmEngine buildFormEngine(URL resource) {
    ...
    if ((beansOfType == null) || (beansOfType.isEmpty())) {
      throw new ActivitiException("no " + IdmEngine.class.getName() + " defined in the application context " + resource.toString());
    }
