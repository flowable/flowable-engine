 ...
 * 
 *   &#64;Rule
 *   public ActivitiIdmRule activitiIdmRule = new ActivitiIdmRule();
 *   
 *   ...
 * }
 * </pre>
 ...
 * 
 * <p>
 * The activitiRule also lets you {@link ActivitiIdmRule#setCurrentTime(Date) set the current time used by the process engine}. This can be handy to control the exact time that is used by the engine
 ...
 */
public class ActivitiIdmRule implements TestRule {

  protected String configurationResource = "activiti.idm.cfg.xml";
  ...
  public ActivitiIdmRule() {
  }

  public ActivitiIdmRule(String configurationResource) {
    this.configurationResource = configurationResource;
  }

  public ActivitiIdmRule(IdmEngine idmEngine) {
