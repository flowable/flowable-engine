 ...
 */
public class ActivitiEntityEventImpl extends ActivitiEventImpl implements ActivitiIdmEntityEvent {

  protected Object entity;

  public ActivitiEntityEventImpl(Object entity, ActivitiIdmEventType type) {
    super(type);
    if (entity == null) {
