 ...
 */
public class ActivitiIdmIllegalArgumentException extends ActivitiIdmException {

  private static final long serialVersionUID = 1L;

  public ActivitiIdmIllegalArgumentException(String message) {
    super(message);
  }

  public ActivitiIdmIllegalArgumentException(String message, Throwable cause) {
    super(message, cause);
  }
}
