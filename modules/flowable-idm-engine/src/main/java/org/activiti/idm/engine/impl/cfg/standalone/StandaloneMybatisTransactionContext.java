...
import org.activiti.idm.engine.impl.cfg.TransactionPropagation;
import org.activiti.idm.engine.impl.cfg.TransactionState;
 ...
 public void commit() {
  ...
  protected void fireTransactionEvent(TransactionState transactionState, boolean executeInNewContext) {
    ...
    if (executeInNewContext) {
      CommandExecutor commandExecutor = commandContext.getIdmEngineConfiguration().getCommandExecutor(); 
