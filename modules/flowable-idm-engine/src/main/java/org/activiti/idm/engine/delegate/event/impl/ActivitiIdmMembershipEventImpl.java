 ...
 */
public class ActivitiIdmMembershipEventImpl extends ActivitiIdmEventImpl implements ActivitiIdmMembershipEvent {

  protected String userId;
  protected String groupId;

  public ActivitiIdmMembershipEventImpl(ActivitiIdmEventType type) {
    super(type);
  }
