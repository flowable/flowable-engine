...
package org.flowable.rest.cmmn.service.api.history;
...
public class HistoricTaskInstanceBaseResource {
    ...
    static {
        ...
        allowedSortProperties.put("caseDefinitionId", HistoricTaskInstanceQueryProperty.SCOPE_DEFINITION_ID);
        allowedSortProperties.put("caseInstanceId", HistoricTaskInstanceQueryProperty.SCOPE_ID);
