...
public class CaseDefinitionCollectionResource {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "nameLike", dataType = "string", value = "Only return case definitions with a name like the given name. Use '%25' (URL-encoded '%') as wildcard.", paramType = "query"),
            @ApiImplicitParam(name = "nameLikeIgnoreCase", dataType = "string", value = "Only return case definitions with a name like the given name, ignoring case. Use '%25' (URL-encoded '%') as wildcard.", paramType = "query"),
            @ApiImplicitParam(name = "key", dataType = "string", value = "Only return case definitions with the given key.", paramType = "query"),
            @ApiImplicitParam(name = "keyLike", dataType = "string", value = "Only return case definitions with a key like the given key. Use '%25' (URL-encoded '%') as wildcard.", paramType = "query"),
            ...
            @ApiImplicitParam(name = "resourceNameLike", dataType = "string", value = "Only return case definitions with a resource name like the given resource name. Use '%25' (URL-encoded '%') as wildcard.", paramType = "query"),
            ...
            @ApiImplicitParam(name = "categoryLike", dataType = "string", value = "Only return case definitions with a category like the given category. Use '%25' (URL-encoded '%') as wildcard.", paramType = "query"),
            ...
            @ApiImplicitParam(name = "tenantIdLike", dataType = "string", value = "Only return case definitions with a tenant id like the given tenant id. Use '%25' (URL-encoded '%') as wildcard.", paramType = "query"),
