...
public class PlanItemInstanceVariableResource extends BaseVariableResource {
    ...
    public RestVariable updateVariable(@ApiParam(name = "planItemInstanceId") @PathVariable("planItemInstanceId") String planItemInstanceId,
        ...
        PlanItemInstance planItem = getPlanItemInstanceFromRequestWithAccessCheck(planItemInstanceId);

        RestVariable result = null;
        if (request instanceof MultipartHttpServletRequest) {
            result = setBinaryVariable((MultipartHttpServletRequest) request, planItem, CmmnRestResponseFactory.VARIABLE_PLAN_ITEM, false,
            ...
            result = setSimpleVariable(restVariable, planItem, false, RestVariable.RestVariableScope.LOCAL, CmmnRestResponseFactory.VARIABLE_PLAN_ITEM);
        }
        return result;
    }
