...
public class HistoricTaskInstanceVariableDataResource extends HistoricTaskInstanceBaseResource {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Indicates the requested task instance was not found or the process instance doesn’t have a variable with the given name or the variable does not  have a binary stream available. Status message provides additional information.") })
