...
public class VariableInstanceCollectionResource extends VariableInstanceBaseResource {
    ...
    public DataResponse<VariableInstanceResponse> getVariableInstances(@ApiParam(hidden = true) @RequestParam Map<String, String> allRequestParams, HttpServletRequest request) {
