...
import org.flowable.dmn.model.DmnDiDecisionServiceDividerLine;
 ...
 * @author Yvo Swillens
 */
public class DmnDiDecisionServiceDividerLineXmlConverter extends BaseDmnXMLConverter {
    
    @Override
    public String getXMLElementName() {
        return DmnXMLConstants.ELEMENT_DI_DECISION_SERVICE_DIVIDER_LINE;
    }
