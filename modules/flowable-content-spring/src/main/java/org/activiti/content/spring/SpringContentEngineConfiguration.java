...
public class SpringContentEngineConfiguration extends ContentEngineConfiguration implements ApplicationContextAware {
  ...
  public CommandInterceptor createTransactionInterceptor() {
    if (transactionManager == null) {
      throw new ActivitiException("transactionManager is required property for SpringContentEngineConfiguration, use " + StandaloneContentEngineConfiguration.class.getName() + " otherwise");
    }
