 ...
 * recorded (at command-context close) via the CMMN history variable manager, which must resolve the owning
 * case definition of the (possibly nested) process rather than treating the scopeId as a case instance id.
 *
