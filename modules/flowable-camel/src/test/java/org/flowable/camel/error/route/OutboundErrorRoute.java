...
public class OutboundErrorRoute extends RouteBuilder {
  ...
  public void configure() throws Exception {
    ...
    from("flowable:ErrorHandling:HandleError").routeId("errorWithDlq").errorHandler(deadLetterChannel("seda:dlq")).log(LoggingLevel.INFO, "Provoked error").bean("brokenService") // <-- throws Exception
        .to("seda:inbound");
  }
