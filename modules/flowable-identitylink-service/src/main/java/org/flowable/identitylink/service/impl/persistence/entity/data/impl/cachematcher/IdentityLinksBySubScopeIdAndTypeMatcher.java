 ...
 */
public class IdentityLinksBySubScopeIdAndTypeMatcher extends CachedEntityMatcherAdapter<IdentityLinkEntity> {
    ...
    public boolean isRetained(IdentityLinkEntity entity, Object parameter) {
        ...
        return entity.getSubScopeId() != null && entity.getSubScopeId().equals(parameterMap.get("subScopeId")) &&
