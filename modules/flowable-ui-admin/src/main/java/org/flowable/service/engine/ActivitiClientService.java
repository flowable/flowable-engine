 ...
 */
package org.flowable.service.engine;
...
import org.flowable.domain.ServerConfig;
import org.flowable.service.AttachmentResponseInfo;
import org.flowable.service.ResponseInfo;
import org.flowable.service.engine.exception.ActivitiServiceException;
...
public class ActivitiClientService {
   ...
   * response-body, in case the status code is 200 - OK. In case the response
   * returns a different status-code, an {@link ActivitiServiceException} is
   ...
   * {@link ActivitiServiceException} is thrown with the error message received
