    ...
    function ($scope, $rootScope, $http, $timeout, $location, $routeParams, $modal, $translate, $q) {
		...
		$scope.deleteDeployment = function() {
            ...
            modalInstance.result.then(function (result) {
                if (result === true) {
                    $http({method: 'DELETE', url: '/app/rest/activiti/form-deployments/' + $routeParams.deploymentId}).
		...
		$scope.executeWhenReady(function() {
		    ...
		    $http({method: 'GET', url: '/app/rest/activiti/form-definitions?deploymentId=' + $routeParams.formDeploymentId}).
  	    	    success(function(data, status, headers, config) {
