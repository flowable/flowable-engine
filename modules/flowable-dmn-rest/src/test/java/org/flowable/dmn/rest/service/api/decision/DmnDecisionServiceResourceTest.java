 ...
 * @author Yvo Swillens
 */
public class DmnDecisionServiceResourceTest extends BaseSpringDmnRestTestCase {

    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/multi-hit.dmn" })
    public void testExecutionDecisionWithDecisionTable() throws Exception {
        // Add decision key
        ...
        HttpPost httpPost = new HttpPost(SERVER_URL_PREFIX + DmnRestUrls.createRelativeResourceUrl(DmnRestUrls.URL_DECISION_SERVICE_EXECUTE));
    ...
    public void testExecutionDecisionWithDecisionTableSingleResult() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        ...
        HttpPost httpPost = new HttpPost(SERVER_URL_PREFIX + DmnRestUrls.createRelativeResourceUrl(DmnRestUrls.URL_DECISION_SERVICE_EXECUTE_SINGLE_RESULT));
        httpPost.setEntity(new StringEntity(requestNode.toString()));
        CloseableHttpResponse response = executeRequest(httpPost, HttpStatus.SC_CREATED);
    ...
    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/multi-hit.dmn" })
    public void testExecutionDecisionWithDecisionTableSingleResultViolated() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("decisionKey", "decision1");
    ...
    public void testExecutionDecisionWithDecisionService() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
    ...
    public void testExecutionDecisionWithDecisionServiceSingleResult() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
    ...
    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/decision-service-multiple-output-decisions.dmn" })
    public void testExecutionDecisionWithDecisionServiceSingleResultViolated() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("decisionKey", "expandedDecisionService");
    ...
    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/multi-hit.dmn" })
    public void testExecutionDecisionTable() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("decisionKey", "decision1");
        ...
        HttpPost httpPost = new HttpPost(SERVER_URL_PREFIX + DmnRestUrls.createRelativeResourceUrl(DmnRestUrls.URL_DECISION_SERVICE_EXECUTE_DECISION));
        httpPost.setEntity(new StringEntity(requestNode.toString()));
        CloseableHttpResponse response = executeRequest(httpPost, HttpStatus.SC_CREATED);
    ...
    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/single-hit.dmn" })
    public void testExecutionDecisionTableSingleResult() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("decisionKey", "decision");
        ...
        HttpPost httpPost = new HttpPost(
                SERVER_URL_PREFIX + DmnRestUrls.createRelativeResourceUrl(DmnRestUrls.URL_DECISION_SERVICE_EXECUTE_DECISION_SINGLE_RESULT));
        httpPost.setEntity(new StringEntity(requestNode.toString()));
        CloseableHttpResponse response = executeRequest(httpPost, HttpStatus.SC_CREATED);
    ...
    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/multi-hit.dmn" })
    public void testExecutionDecisionTableSingleResultViolated() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("decisionKey", "decision1");
    ...
    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/decision-service-multiple-output-decisions.dmn" })
    public void testExecutionDecisionService() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("decisionKey", "expandedDecisionService");
        ...
        HttpPost httpPost = new HttpPost(SERVER_URL_PREFIX + DmnRestUrls.createRelativeResourceUrl(DmnRestUrls.URL_DECISION_SERVICE_EXECUTE_DECISION_SERVICE));
        httpPost.setEntity(new StringEntity(requestNode.toString()));
        CloseableHttpResponse response = executeRequest(httpPost, HttpStatus.SC_CREATED);
    ...
    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/evaluate-mortgage-request-service.dmn" })
    public void testExecutionDecisionServiceSingleResult() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("decisionKey", "evaluateMortgageRequestService");
        ...
        HttpPost httpPost = new HttpPost(
                SERVER_URL_PREFIX + DmnRestUrls.createRelativeResourceUrl(DmnRestUrls.URL_DECISION_SERVICE_EXECUTE_DECISION_SERVICE_SINGLE_RESULT));
        httpPost.setEntity(new StringEntity(requestNode.toString()));
        CloseableHttpResponse response = executeRequest(httpPost, HttpStatus.SC_CREATED);
    ...
    @DmnDeployment(resources = { "org/flowable/dmn/rest/service/api/decision/decision-service-multiple-output-decisions.dmn" })
    public void testExecutionDecisionServiceSingleResultViolated() throws Exception {
        // Add decision key
        ObjectNode requestNode = objectMapper.createObjectNode();
        requestNode.put("decisionKey", "expandedDecisionService");
