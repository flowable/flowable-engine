...
public class DecisionTableCollectionResourceTest extends BaseSpringDmnRestTestCase {
    ...
    public void testGetDecisionTables() throws Exception {
        ...
        try {
            DmnDeployment firstDeployment = dmnRepositoryService.createDeployment().name("Deployment 1").addClasspathResource("org/flowable/rest/dmn/service/api/repository/simple.dmn").category("cat one")
                    .deploy();

            DmnDeployment secondDeployment = dmnRepositoryService.createDeployment().name("Deployment 2").addClasspathResource("org/flowable/rest/dmn/service/api/repository/simple.dmn").category("cat two")
                    .addClasspathResource("org/flowable/rest/dmn/service/api/repository/simple-2.dmn").deploy();
            ...
            url = baseUrl + "?resourceName=org/flowable/rest/dmn/service/api/repository/simple-2.dmn";
            assertResultsPresentInDataResponse(url, decisionTwo.getId());
