 ...
 */
public class SignalMongoDbTest extends AbstractMongoDbTest {
    
    @Test
    public void testBoundarySignalEventCompleteTask() {
        repositoryService.createDeployment().addClasspathResource("signalTask.bpmn20.xml").deploy();
        
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("signalTask");
    ...
    @Test
    public void testBoundarySignalEventTriggerSignal() {
        repositoryService.createDeployment().addClasspathResource("signalTask.bpmn20.xml").deploy();
