...
public class DmnEngineAgendaSessionFactory implements SessionFactory {
    ...
    public Class<?> getSessionType() {
        return DmnEngineAgenda.class;
    }
    @Override
    public Session openSession(CommandContext commandContext) {
        return dmnEngineAgendaFactory.createAgenda(commandContext);
    }
}
