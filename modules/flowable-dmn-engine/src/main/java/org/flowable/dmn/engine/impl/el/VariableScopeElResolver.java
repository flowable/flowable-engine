...
/**
 * Implementation of an {@link ELResolver} that resolves expressions with the variables as context.
 * 
...
public class VariableScopeElResolver extends ELResolver {
    ...
    public VariableScopeElResolver(Map<String, Object> variables) {
