...
public class SchemaOperationsDmnEngineBuild implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        DmnEngineConfiguration engineConfiguration = CommandContextUtil.getDmnEngineConfiguration(commandContext);
        String databaseSchemaUpdate = engineConfiguration.getDatabaseSchemaUpdate();
        ((DmnDbSchemaManager) engineConfiguration.getSchemaManager()).initSchema(databaseSchemaUpdate);
