...
import org.activiti.dmn.engine.impl.util.ReflectUtil;
...
public abstract class DmnEngines {
  ...
  public synchronized static void init() {
    if (!isInitialized()) {
      ...
      try {
        ...
        throw new ActivitiException("problem retrieving activiti.dmn.cfg.xml resources on the classpath: " + System.getProperty("java.class.path"), e);
      }
      ...
      try { 
        ...
        throw new ActivitiException("problem retrieving activiti-dmn-context.xml resources on the classpath: " + System.getProperty("java.class.path"), e); 
      } 
  ...
  protected static void initDmnEngineFromSpringResource(URL resource) {
    try {
      Class<?> springConfigurationHelperClass = ReflectUtil.loadClass("org.activiti.dmn.spring.SpringDmnConfigurationHelper");
      ...
      throw new ActivitiException("couldn't initialize dmn engine from spring configuration resource " + resource.toString() + ": " + e.getMessage(), e);
    }
  }
