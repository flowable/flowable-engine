 ...
 * @author Yvo Swillens
 */
class CollectionsNotContainsAnyTest extends BaseFlowableDmnTest {

    @Test
    @DmnDeployment(resources = "org/flowable/dmn/engine/test/runtime/contains_NOT_ANY.dmn")
    public void testNotContainsAnyTrue() {
    ...
    @Test
    @DmnDeployment(resources = "org/flowable/dmn/engine/test/runtime/contains_NOT_ANY.dmn")
    public void testNotContainsAnyFalse() {
        Map<String, Object> processVariablesInput = new HashMap<>();
