...
public class CancelCallActivityTest extends PluggableActivitiTestCase {
  ...
  public void testCancelCallActivity() throws Exception {
    ...
    assertEquals(ActivitiEngineEventType.ENTITY_CREATED, entityEvent.getType());
    ...
    assertEquals(ActivitiEngineEventType.PROCESS_STARTED, activitiEvent.getType());
    ...
    assertEquals(ActivitiEngineEventType.TASK_CREATED, entityEvent.getType());
    ...
    assertEquals(ActivitiEngineEventType.ACTIVITY_CANCELLED, activityEvent.getType());
    ...
    assertEquals(ActivitiEngineEventType.ACTIVITY_CANCELLED, taskCancelledEvent.getType());
    ...
    assertEquals(ActivitiEngineEventType.PROCESS_CANCELLED, processCancelledEvent.getType());
  ...
  class CallActivityEventListener implements ActivitiEventListener {
    ...
    public void onEvent(ActivitiEvent event) {
      ActivitiEngineEventType engineEventType = (ActivitiEngineEventType) event.getType();
