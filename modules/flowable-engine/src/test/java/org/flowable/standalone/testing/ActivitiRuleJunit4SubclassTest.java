 ...
 * 
 * When running the test suite over this class, JUnit will execute the test from {@link ActivitiRuleJunit4Test}. This means that the code in {@link org.flowable.engine.impl.test.TestHelper} needs to
