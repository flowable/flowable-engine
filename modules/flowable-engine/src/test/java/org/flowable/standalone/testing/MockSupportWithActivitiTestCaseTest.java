 ...
 * @author Joram Barrez
 */
public class MockSupportWithActivitiTestCaseTest extends FlowableTestCase {
  ...
  @Deployment(resources = { "org/flowable/standalone/testing/MockSupportWithActivitiTestCaseTest.testMockedServiceTaskAnnotation.bpmn20.xml" })
  ...
  @Deployment(resources = { "org/flowable/standalone/testing/MockSupportWithActivitiTestCaseTest.testNoOpServiceTasksAnnotation.bpmn20.xml" })
