...
public class MockSupportWithActivitiRuleTest {
  ...
  public FlowableRule activitiRule = new FlowableRule() {
    ...
    protected void configureProcessEngine() {
      ...
      activitiRule.mockSupport().mockServiceTaskWithClassDelegate("com.yourcompany.anotherDelegate", "org.flowable.standalone.testing.helpers.ServiceTaskTestMock");
    }
  ...
  @Test
  @Deployment(resources = { "org/flowable/standalone/testing/MockSupportWithActivitiRuleTest.testMockedServiceTaskAnnotation.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "org/flowable/standalone/testing/MockSupportWithActivitiRuleTest.testNoOpServiceTasksAnnotation.bpmn20.xml" })
