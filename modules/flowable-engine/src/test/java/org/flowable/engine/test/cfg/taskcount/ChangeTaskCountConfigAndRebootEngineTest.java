...
public class ChangeTaskCountConfigAndRebootEngineTest extends ResourceFlowableTestCase {
    ...
    private void checkEnableFlagBetweenTasks() {
        ...
        org.flowable.task.service.Task firstTask = taskService.createTaskQuery().processInstanceId(processInstance.getId()).singleResult();
    ...
    protected void assertTaskCountFlag(org.flowable.task.service.Task task, boolean enableTaskCountFlag) {
