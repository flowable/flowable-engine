...
public class ProcessInstanceMigrationMultiInstanceTest extends PluggableFlowableTestCase {
    ...
    public void testMigrateActivityToSequentialMultiInstanceActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            ...
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("userTask1Id", "seqTasks"))
    ...
    public void testMigrateActivityToParallelMultiInstanceActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            ...
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("userTask1Id", "parallelTasks"))
            .withProcessInstanceVariable("nrOfLoops", 3);
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateSequentialMultiInstanceActivityToSimpleActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            ...
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("seqTasks", "userTask1Id"));
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateParallelMultiInstanceActivityToSimpleActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procSimpleOneTask.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("parallelTasks", "userTask1Id"));
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateSequentialMultiInstanceActivityToParallelMultiInstanceActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procParallelMultiInst.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("seqTasks", "parallelTasks"));
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateParallelMultiInstanceActivityToSequentialMultiInstanceActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procSequentialMultiInst.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("parallelTasks", "seqTasks"));
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateActivityToSequentialMultiInstanceSubProcess() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procSequentialMultiInst.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("userTask1Id", "sequentialMISubProcess"))
            .withProcessInstanceVariable("nrOfLoops", 3);
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateActivityToParallelMultiInstanceSubProcess() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procParallelMultiInst.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("userTask1Id", "parallelMISubProcess"))
            .withProcessInstanceVariable("nrOfLoops", 3);
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateSequentialMultiInstanceSubProcessToSimpleActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procSimpleOneTask.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("sequentialMISubProcess", "userTask1Id"));
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateParallelMultiInstanceSubProcessToSimpleActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procSimpleOneTask.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("parallelMISubProcess", "userTask1Id"));
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateNestedSequentialMultiInstanceSubProcessActivityToOuterSequentialSubProcessActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procSequentialMultiInst.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("nestedSequentialMISubProcess", "sequentialMISubProcess"));
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
    ...
    public void testMigrateNestedParallelMultiInstanceSubProcessActivityToOuterParallelSubProcessActivity() {
        ...
        ProcessInstanceMigrationBuilder processInstanceMigrationBuilder = runtimeService.createProcessInstanceMigrationBuilder()
            .migrateToProcessDefinition(procParallelMultiInst.getId())
            .addActivityMigrationMapping(ProcessInstanceActivityMigrationMapping.createMappingFor("nestedParallelMISubProcess", "parallelMISubProcess"));
        ProcessInstanceMigrationValidationResult processInstanceMigrationValidationResult = processInstanceMigrationBuilder.validateMigration(processInstance.getId());
        assertThat(processInstanceMigrationValidationResult.getValidationMessages()).isEmpty();
        processInstanceMigrationBuilder.migrate(processInstance.getId());
