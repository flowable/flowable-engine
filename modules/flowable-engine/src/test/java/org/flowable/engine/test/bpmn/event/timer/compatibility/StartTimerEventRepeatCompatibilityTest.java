...
public class StartTimerEventRepeatCompatibilityTest extends TimerEventCompatibilityTest {
    ...
    public void testCycleDateStartTimerEvent() throws Exception {
        ...
        assertThat(eventCreatedCount); // 20 job entities created).isCloseTo(20, within(2 per job (timer and executable job))
        assertThat(eventDeletedCount); // 20 jobs entities deleted).isCloseTo(20, within(2 per job (timer and executable job))
