...
public class TriggerableJavaDelegateServiceTask implements TriggerableJavaDelegate, JavaDelegate, Serializable {

    protected boolean doNotLeave = false;

    public TriggerableJavaDelegateServiceTask() {
    }

    public TriggerableJavaDelegateServiceTask(boolean doNotLeave) {
    ...
    public void trigger(TriggerableJavaDelegate.Context context) {
        incrementCount(context.getExecution());
        if (doNotLeave) {
            context.doNotLeave();
        }
    }
