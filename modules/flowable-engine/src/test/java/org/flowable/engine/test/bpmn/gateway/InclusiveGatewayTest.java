...
public class InclusiveGatewayTest extends PluggableFlowableTestCase {
    ...
    public void testMultipleProcessInstancesMergedBug() {
        ...
        org.flowable.task.service.Task taskCInPi1 = taskService.createTaskQuery().processInstanceId(processInstance1.getId()).singleResult();
        ...
        org.flowable.task.service.Task taskBInPi2 = taskService.createTaskQuery().processInstanceId(processInstance2.getId()).singleResult();
