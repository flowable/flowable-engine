...
public class SubProcessTest extends PluggableFlowableTestCase {
    ...
    public void testSimpleSubProcessWithTimer() {
        ...
        org.flowable.task.service.Task escalationTask = taskService.createTaskQuery().processInstanceId(pi.getId()).singleResult();
    ...
    public void IGNORE_testSimpleSubProcessWithConcurrentTimer() {
        ...
        org.flowable.task.service.Task subProcessTask = taskQuery.singleResult();
        assertEquals("Task in subprocess", subProcessTask.getName());
        ...
        List<org.flowable.task.service.Task> tasksAfterTimer = taskQuery.list();
        assertEquals(2, tasksAfterTimer.size());
        org.flowable.task.service.Task taskAfterTimer1 = tasksAfterTimer.get(0);
        org.flowable.task.service.Task taskAfterTimer2 = tasksAfterTimer.get(1);
    ...
    public void testNestedSimpleSubProcess() {
        ...
        taskService.complete(subProcessTask.getId());
        org.flowable.task.service.Task taskAfterSubProcesses = taskService.createTaskQuery().processInstanceId(pi.getId()).singleResult();
    ...
    public void testNestedSimpleSubprocessWithTimerOnInnerSubProcess() {
        ...
        org.flowable.task.service.Task taskAfterSubProcess = taskService.createTaskQuery().processInstanceId(pi.getId()).singleResult();
    ...
    public void testSimpleParallelSubProcess() {
        ...
        List<org.flowable.task.service.Task> subProcessTasks = taskService.createTaskQuery().processInstanceId(pi.getId()).orderByTaskName().asc().list();

        // Tasks are ordered by name (see query)
        org.flowable.task.service.Task taskA = subProcessTasks.get(0);
        org.flowable.task.service.Task taskB = subProcessTasks.get(1);
    ...
    public void testSimpleParallelSubProcessWithTimer() {
        ...
        List<org.flowable.task.service.Task> subProcessTasks = taskService.createTaskQuery().processInstanceId(processInstance.getId()).orderByTaskName().asc().list();
        ...
        org.flowable.task.service.Task taskAfterTimer = taskService.createTaskQuery().processInstanceId(processInstance.getId()).singleResult();
    ...
    public void testTwoSubProcessInParallel() {
        ...
        TaskQuery taskQuery = taskService.createTaskQuery().processInstanceId(pi.getId()).orderByTaskName().asc();
        List<org.flowable.task.service.Task> tasks = taskQuery.list();
    ...
    public void testTwoSubProcessInParallelWithinSubProcess() {
        ...
        // After process start, both tasks in the subprocesses should be active
        org.flowable.task.service.Task taskA = tasks.get(0);
        org.flowable.task.service.Task taskB = tasks.get(1);
        ...
        org.flowable.task.service.Task taskAfterSubProcess = taskQuery.singleResult();
    ...
    public void testTwoNestedSubProcessesInParallelWithTimer() {
        ...
        org.flowable.task.service.Task taskAfterTimer = taskQuery.singleResult();
        assertEquals("Task after timer", taskAfterTimer.getName());
    ...
    public void testDataObjectScope() {
        ...
        org.flowable.task.service.Task currentTask = taskService.createTaskQuery().processInstanceId(pi.getId()).singleResult();
