...
public class TaskEventsTest extends PluggableFlowableTestCase {
    ...
    public void testTaskEventsInProcess() throws Exception {
        ...
        assertTrue(event.getEntity() instanceof org.flowable.task.service.Task);
        org.flowable.task.service.Task taskFromEvent = (org.flowable.task.service.Task) event.getEntity();
        ...
        assertTrue(event.getEntity() instanceof org.flowable.task.service.Task);
        taskFromEvent = (org.flowable.task.service.Task) event.getEntity();
        assertEquals(task.getId(), taskFromEvent.getId());
        assertExecutionDetails(event, processInstance);
    ...
    public void testEventFiringOrdering() {
        ...
        TestFlowableEntityEventTaskListener tlistener = new TestFlowableEntityEventTaskListener(org.flowable.task.service.Task.class);
        ...
        try {
            ...
            assertEquals(FlowableEngineEventType.TASK_CREATED, event.getType());
            assertTrue(event.getEntity() instanceof org.flowable.task.service.Task);
            org.flowable.task.service.Task taskFromEvent = tlistener.getTasks().get(2);
            assertEquals(task.getId(), taskFromEvent.getId());
    ...
    protected void setUp() throws Exception {
        super.setUp();
        listener = new TestFlowableEntityEventListener(org.flowable.task.service.Task.class);
