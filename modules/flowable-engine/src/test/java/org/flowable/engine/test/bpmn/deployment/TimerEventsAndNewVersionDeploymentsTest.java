...
public class TimerEventsAndNewVersionDeploymentsTest extends PluggableFlowableTestCase {
  ...
  private static final String TEST_TIMER_PROCESS = 
      "org/flowable/engine/test/bpmn/deployment/TimerEventsAndNewVersionDeploymentsTest.timerTest.bpmn20.xml";
  
  private static final String TEST_PROCESS_NO_TIMER =
      "org/flowable/engine/test/bpmn/deployment/TimerEventsAndNewVersionDeploymentsTest.processWithoutEvents.bpmn20.xml";
