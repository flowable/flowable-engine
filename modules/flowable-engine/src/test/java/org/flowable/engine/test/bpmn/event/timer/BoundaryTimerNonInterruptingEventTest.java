...
public class BoundaryTimerNonInterruptingEventTest extends PluggableFlowableTestCase {
    ...
    public void testMultipleTimersOnUserTask() {
        ...
        org.flowable.task.service.Task task1 = taskService.createTaskQuery().singleResult();
        ...
        List<org.flowable.task.service.Task> taskList = taskService.createTaskQuery().orderByTaskName().desc().list();
        ...
        assertEquals(1L, taskService.createTaskQuery().count());
        org.flowable.task.service.Task escalationTask = taskService.createTaskQuery().singleResult();
    ...
    public void testJoin() {
        ...
        assertEquals(1L, taskService.createTaskQuery().count());
        org.flowable.task.service.Task task2 = taskService.createTaskQuery().singleResult();
    ...
    public void testTimerOnConcurrentTasks() {
        ...
        org.flowable.task.service.Task task = taskService.createTaskQuery().taskDefinitionKey("timerFiredTask").singleResult();
        taskService.complete(task.getId());
        assertEquals(2, taskService.createTaskQuery().count());

        // Complete other tasks
        for (org.flowable.task.service.Task t : taskService.createTaskQuery().list()) {
    ...
    public void testTimerOnConcurrentTasks2() {
        ...
        org.flowable.task.service.Task task = taskService.createTaskQuery().taskDefinitionKey("firstTask").singleResult();
        taskService.complete(task.getId());
    ...
    public void testTimerWithCycle() throws Exception {
        ...
        org.flowable.task.service.Task task = taskService.createTaskQuery().taskDefinitionKey("task").singleResult();
        taskService.complete(task.getId());
    ...
    public void testTimerOnEmbeddedSubprocess() {
        ...
        List<org.flowable.task.service.Task> tasks = tq.list();
    ...
    public void testTimerOnConcurrentSubprocess() {
        ...
        org.flowable.task.service.Task task = taskService.createTaskQuery().taskDefinitionKey("sub1task1").singleResult();
        taskService.complete(task.getId());
