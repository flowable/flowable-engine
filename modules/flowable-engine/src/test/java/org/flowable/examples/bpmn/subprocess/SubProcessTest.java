...
public class SubProcessTest extends PluggableFlowableTestCase {
    ...
    public void testSimpleSubProcess() {
        ...
        org.flowable.task.service.Task investigateHardwareTask = tasks.get(0);
        org.flowable.task.service.Task investigateSoftwareTask = tasks.get(1);
        ...
        org.flowable.task.service.Task writeReportTask = taskService.createTaskQuery().processInstanceId(pi.getId()).singleResult();
