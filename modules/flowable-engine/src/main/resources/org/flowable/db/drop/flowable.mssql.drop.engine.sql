...
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACT_INST_START') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACT_INST_START;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACT_INST_END') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACT_INST_END;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACT_INST_PROCINST') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACT_INST_PROCINST;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACT_INST_EXEC') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACT_INST_EXEC;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_ACTINST_PROC_DEF') drop index ACT_RU_ACTINST.ACT_IDX_ACTINST_PROC_DEF;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_ACTINST_EXECUTION') drop index ACT_RU_ACTINST.ACT_IDX_ACTINST_EXECUTION;
...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_ACTINST') alter table ACT_RU_ACTINST drop constraint ACT_FK_RU_ACTINST_PROCDEF;
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_ACTINST') alter table ACT_RU_ACTINST drop constraint ACT_FK_RU_ACTINST_PROCINST;
...
if exists (select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'ACT_RU_ACTINST') drop table ACT_RU_ACTINST;
