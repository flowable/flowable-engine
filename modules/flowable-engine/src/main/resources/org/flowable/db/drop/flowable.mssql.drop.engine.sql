...
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACTI_START') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACTI_START;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACTI_END') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACTI_END;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACTI_PROC') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACTI_PROC;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACTI_PROC_ACT') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACTI_PROC_ACT;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACTI_EXEC') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACTI_EXEC;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACTI_EXEC_ACT') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACTI_EXEC_ACT;
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_RU_ACTI_TASK') drop index ACT_RU_ACTINST.ACT_IDX_RU_ACTI_TASK;
