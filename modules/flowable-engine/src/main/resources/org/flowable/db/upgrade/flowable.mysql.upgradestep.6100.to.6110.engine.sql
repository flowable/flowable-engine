...
alter table ACT_RU_JOB add column CREATE_TIME_ timestamp(3);
alter table ACT_RU_TIMER_JOB add column CREATE_TIME_ timestamp(3);
alter table ACT_RU_SUSPENDED_JOB add column CREATE_TIME_ timestamp(3);
alter table ACT_RU_DEADLETTER_JOB add column CREATE_TIME_ timestamp(3);
