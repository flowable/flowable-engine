...
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_PRO_SUPER_PROCINST') drop index ACT_HI_PROCINST.ACT_IDX_HI_PRO_SUPER_PROCINST;
...
IF EXISTS (SELECT name FROM sysindexes WHERE name = 'ACT_IDX_HI_ACT_INST_EXEC') drop index ACT_HI_ACTINST.ACT_IDX_HI_ACT_INST_EXEC;
