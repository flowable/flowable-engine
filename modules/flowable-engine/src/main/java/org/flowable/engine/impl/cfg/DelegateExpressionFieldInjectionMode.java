...
public enum DelegateExpressionFieldInjectionMode {
     ...
     * 
     * Using the {@link DelegateHelper#getField(org.flowable.engine.delegate.DelegateExecution, String)} method is not possible when using this mode, unless the Expressions are still defined as
