 ...
 */
public class UnfinishedActivityInstanceMatcher extends CachedEntityMatcherAdapter<ActivityInstanceEntity> {

    @Override
    public boolean isRetained(ActivityInstanceEntity entity, Object parameter) {
