 ...
 */
public class DelegateFlowableTransactionDependentEventListener implements TransactionDependentFlowableEventListener {

    protected String className;
    protected TransactionDependentFlowableEventListener delegateInstance;
    protected boolean failOnException;

    public DelegateFlowableTransactionDependentEventListener(String className, Class<?> entityClass) {
