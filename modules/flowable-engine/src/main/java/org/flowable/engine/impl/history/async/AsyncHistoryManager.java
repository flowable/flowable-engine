...
public class AsyncHistoryManager extends AbstractHistoryManager {
  ...
  public void recordProcessInstanceStart(ExecutionEntity processInstance, FlowElement startElement) {
    if (isHistoryLevelAtLeast(HistoryLevel.ACTIVITY)) {
      ...
      putIfNotNull(data, HistoryJsonConstants.PROCESS_DEFINITION_VERSION, processInstance.getProcessDefinitionVersion() != null ? 
          Integer.toString(processInstance.getProcessDefinitionVersion()) : null);
