 ...
 */
public interface HistoryJobDataManager extends DataManager<HistoryJobEntity> {

    List<HistoryJobEntity> findHistoryJobsToExecute(Page page);

    List<HistoryJobEntity> findHistoryJobsByExecutionId(final String executionId);

    List<HistoryJobEntity> findHistoryJobsByProcessInstanceId(final String processInstanceId);
