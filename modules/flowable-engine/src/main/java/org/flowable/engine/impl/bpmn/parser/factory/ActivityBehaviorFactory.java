...
public interface ActivityBehaviorFactory {
    ...
    MessageStartEventActivityBehavior createMessageStartEventActivityBehavior(StartEvent startEvent, MessageEventDefinition messageEventDefinition);

    SignalStartEventActivityBehavior createSignalStartEventActivityBehavior(StartEvent startEvent, SignalEventDefinition signalEventDefinition, Signal signal);

    TimerStartEventActivityBehavior createTimerStartEventActivityBehavior(StartEvent startEvent, TimerEventDefinition timerEventDefinition);

    EventRegistryStartEventActivityBehavior createEventRegistryStartEventActivityBehavior(StartEvent startEvent, String eventDefinitionKey, boolean manualCorrelation);
