...
public abstract class VariableScopeImpl extends AbstractEntity implements Serializable, VariableScope {
     ...
     * 
     * @param sourceExecution
     *            The execution where the variable was originally set, used for history data.
     * @param fetchAllVariables
     *            If true, all existing variables will be fetched when setting the variable.
     */
