...
public class ProcessInstanceMigrationJobHandler extends AbstractProcessInstanceMigrationJobHandler {
    ...
    public void execute(JobEntity job, String configuration, VariableScope variableScope, CommandContext commandContext) {
        ...
        try {
            processInstanceMigrationManager.migrateProcessInstance(batchPart.getProcessInstanceId(), migrationDocument, commandContext);
        ...
        batchPart.complete(currentTime, resultAsJsonString);
    }
