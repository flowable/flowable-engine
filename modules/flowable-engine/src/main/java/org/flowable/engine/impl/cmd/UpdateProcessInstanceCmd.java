...
/**
 * {@link Command} that updates properties of an existing process instance.
 *
 * @author Tijs Rademakers
 */
public class UpdateProcessInstanceCmd implements Command<Void>, Serializable {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        if (builder.isNameSet()) {
            ...
            CommandContextUtil.getHistoryManager(commandContext).recordProcessInstanceNameChange(processInstance, builder.getName());
        }
