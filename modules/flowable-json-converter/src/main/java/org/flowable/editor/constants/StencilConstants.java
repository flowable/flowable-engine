...
public interface StencilConstants {
    ...
    final String PROPERTY_DECISIONTABLE_UPDATED_VARIABLE = "decisiontaskupdatedvariable";
    final String PROPERTY_DECISIONTABLE_UPDATED_VARIABLE_KEY = "decisionTaskUpdatedVariable";
