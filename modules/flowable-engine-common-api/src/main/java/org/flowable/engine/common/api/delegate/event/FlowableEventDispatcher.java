...
/**
 * Dispatcher which allows for adding and removing {@link FlowableEventListener} s to the Activiti Engine as well as dispatching {@link FlowableEvent} to all the listeners registered.
 * 
