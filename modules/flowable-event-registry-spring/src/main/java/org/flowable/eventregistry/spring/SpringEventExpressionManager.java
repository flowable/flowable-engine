 ...
 */
public class SpringEventExpressionManager extends DefaultExpressionManager {
     ...
     */
    public SpringEventExpressionManager(ApplicationContext applicationContext, Map<Object, Object> beans) {
        super(beans);
