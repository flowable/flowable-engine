...
public class AbstractAutoDeploymentStrategyTest {
    ...
    @Mock
    protected EventRegistryEngine eventRegistryEngineMock;

    @Mock
    protected EventRepositoryService repositoryServiceMock;

    @Mock
    protected EventDeploymentBuilder deploymentBuilderMock;
    ...
    @Mock
    private EventDeployment deploymentMock;
    ...
    public void before() throws Exception {
        when(eventRegistryEngineMock.getEventRepositoryService()).thenReturn(repositoryServiceMock);
