...
public class HistoricDetailQueryResource extends HistoricDetailBaseResource {
    ...
    public DataResponse<HistoricDetailResponse> queryHistoricDetail(@RequestBody HistoricDetailQueryRequest queryRequest, @ApiParam(hidden = true) @RequestParam Map<String, String> allRequestParams) {
