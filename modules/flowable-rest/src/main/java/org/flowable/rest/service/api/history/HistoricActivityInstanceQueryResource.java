...
public class HistoricActivityInstanceQueryResource extends HistoricActivityInstanceBaseResource {
    ...
    @ApiOperation(value = "Query for historic activity instances", tags = {"History", "Query" },
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "sort", dataType = "string", value = "The field to sort by. Defaults to 'startTime'.", allowableValues = "activityId,activityName,activityType,duration,endTime,executionId,activityInstanceId,processDefinitionId,processInstanceId,startTime,tenantId", paramType = "body"),
    })
    @ApiResponses(value = {
