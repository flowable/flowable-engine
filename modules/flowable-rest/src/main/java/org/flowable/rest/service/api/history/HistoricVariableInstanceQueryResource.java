...
public class HistoricVariableInstanceQueryResource extends HistoricVariableInstanceBaseResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "sort", dataType = "string", value = "The field to sort by. Defaults to 'variableName'.", allowableValues = "processInstanceId,variableName", paramType = "query"),
    ...
    @PostMapping(value = "/query/historic-variable-instances", produces = "application/json")
