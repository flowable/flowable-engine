...
public class ProcessInstanceQueryResource extends BaseProcessInstanceResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "sort", dataType = "string", value = "The field to sort by. Defaults to 'id'.", allowableValues = "processDefinitionId,processDefinitionKey,id,startTime,tenantId,businessKey", paramType = "query"),
