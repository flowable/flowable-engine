...
public class TaskVariableResource extends TaskVariableBaseResource {
    ...
    @ApiOperation(value = "Update an existing variable on a task", tags = { "Tasks" }, nickname = "updateTaskInstanceVariable", notes = "## Request body for updating simple (non-binary) variables\n\n"
            + " ```JSON\n" + "{\n" + "  \"name\" : \"myTaskVariable\",\n" + "  \"scope\" : \"local\",\n" + "  \"type\" : \"string\",\n"
