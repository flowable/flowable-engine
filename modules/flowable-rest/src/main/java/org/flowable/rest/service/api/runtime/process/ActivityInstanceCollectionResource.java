...
public class ActivityInstanceCollectionResource extends ActivityInstanceBaseResource {
    ...
    @ApiOperation(value = "List activity instances", tags = { "History" }, nickname = "listActivityInstances", notes = "For all 'Like' parameters the '%' wildcard character must be URL-encoded as '%25' (for example '?nameLike=acme%25' to match names starting with 'acme').")
    @ApiResponses(value = {
