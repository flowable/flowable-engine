...
public class HistoricProcessInstanceQueryResource extends HistoricProcessInstanceBaseResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "sort", dataType = "string", value = "The field to sort by. Defaults to 'processInstanceId'.", allowableValues = "processInstanceId,processDefinitionId,businessKey,startTime,endTime,duration,tenantId", paramType = "query"),
    ...
    public DataResponse<HistoricProcessInstanceResponse> queryProcessInstances(@RequestBody HistoricProcessInstanceQueryRequest queryRequest, @ApiParam(hidden = true) @RequestParam Map<String, String> allRequestParams) {
