...
public class HistoricTaskInstanceQueryResource extends HistoricTaskInstanceBaseResource {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "sort", dataType = "string", value = "The field to sort by. Defaults to 'taskInstanceId'.", allowableValues = "deleteReason,duration,endTime,executionId,taskInstanceId,processDefinitionId,processInstanceId,start,assignee,taskDefinitionKey,description,dueDate,name,owner,priority,tenantId,startTime", paramType = "body"),
    })
    @ApiResponses(value = {
