...
public class FormDefinitionResourceDataResource  {
  ...
  public byte[] getDecisionTableResource(@PathVariable String formDefinitionId, HttpServletResponse response) {
    ...
    if (formDefinition == null) {
      throw new ActivitiObjectNotFoundException("Could not find a form definition with id '" + formDefinitionId);
    }
    ...
    if (deployment == null) {
      throw new ActivitiObjectNotFoundException("Could not find a deployment with id '" + formDefinition.getDeploymentId());
    }
    ...
    if (resourceList.contains(formDefinition.getResourceName())) {
      ...
      throw new ActivitiObjectNotFoundException("Could not find a resource with id '" + 
