...
public final class FormRestUrls {
  ...
  public static final String SEGMENT_FORM_RESOURCE = "forms";
   ...
   */
  public static final String[] URL_FORM_COLLECTION = { SEGMENT_REPOSITORY_RESOURCES, SEGMENT_FORM_RESOURCE };

  /**
   * URL template for a single form: <i>/form-repository/forms/{0:formId}</i>
   */
  public static final String[] URL_FORM = { SEGMENT_REPOSITORY_RESOURCES, SEGMENT_FORM_RESOURCE, "{0}" };

  /**
   * URL template for a single form model: <i>/form-repository/forms/{0:formId}/model</i>
   */
  public static final String[] URL_FORM_MODEL = { SEGMENT_REPOSITORY_RESOURCES, SEGMENT_FORM_RESOURCE, "{0}", SEGMENT_FORM_MODEL };

  /**
   * URL template for the resource of a single form: <i>/form-repository/forms/{0:formId}/resourcedata</i>
   */
  public static final String[] URL_FORM_RESOURCE_CONTENT = { SEGMENT_REPOSITORY_RESOURCES, SEGMENT_FORM_RESOURCE, "{0}", SEGMENT_DEPLOYMENT_ARTIFACT_RESOURCE_CONTENT };
