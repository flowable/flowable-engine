...
public class InboundChannelModel extends ChannelModel {
    ...
    public String getChannelModelHashKey() {
        ...
        return new StringBuilder().append(type).append(deserializerType).append(deserializerDelegateExpression)
                .append(payloadExtractorDelegateExpression).append(eventTransformerDelegateExpression)
