...
public class CustomPersistentRememberMeServices extends AbstractRememberMeServices {
  ...
  protected void addCookie(HttpServletRequest request, HttpServletResponse response) {
    setCookie(new String[] { System.currentTimeMillis() + "1", System.currentTimeMillis() + "2" }, tokenMaxAgeInSeconds, request, response);
  }
