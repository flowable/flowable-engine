...
/**
 * Custom implementation of {@link FormLoginConfigurer}, to have control over
 * the auth filter instance.
 */
public final class CustomFormLoginConfig<H extends HttpSecurityBuilder<H>> extends AbstractAuthenticationFilterConfigurer<H, CustomFormLoginConfig<H>, CustomUsernamePasswordAuthenticationFilter> {
   ...
   * AbstractAuthenticationFilterConfigurer#createLoginProcessingUrlMatcher(java.lang.String)
   */
  @Override
  ...
  /**
   * If available, initializes the {@link DefaultLoginPageGeneratingFilter}
   * shared object.
   *
   * @param http
