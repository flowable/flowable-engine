...
public class CmmnDeploymentService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CmmnDeploymentService.class);
    ...
    public JsonNode getDeployment(ServerConfig serverConfig, String deploymentId) {
        HttpGet get = new HttpGet(clientUtil.getServerUrl(serverConfig, "cmmn-repository/deployments/" + deploymentId));
        return clientUtil.executeRequest(get, serverConfig);
    }
    ...
    public void deleteDeployment(ServerConfig serverConfig, HttpServletResponse httpResponse, String appDeploymentId) {
        HttpDelete delete = new HttpDelete(clientUtil.getServerUrl(serverConfig, clientUtil.createUriBuilder("cmmn-repository/deployments/" + appDeploymentId)));
