...
public class SchemaOperationsEventRegistryEngineBuild implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        EventRegistryEngineConfiguration engineConfiguration = CommandContextUtil.getEventRegistryConfiguration(commandContext);
        String databaseSchemaUpdate = engineConfiguration.getDatabaseSchemaUpdate();
        ((EventDbSchemaManager) engineConfiguration.getSchemaManager()).initSchema(databaseSchemaUpdate);
