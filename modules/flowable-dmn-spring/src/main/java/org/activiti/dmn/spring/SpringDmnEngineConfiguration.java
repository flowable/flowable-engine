...
package org.activiti.dmn.spring;
...
import org.activiti.dmn.spring.autodeployment.AutoDeploymentStrategy;
import org.activiti.dmn.spring.autodeployment.DefaultAutoDeploymentStrategy;
import org.activiti.dmn.spring.autodeployment.ResourceParentFolderAutoDeploymentStrategy;
...
public class SpringDmnEngineConfiguration extends DmnEngineConfiguration implements ApplicationContextAware {
  ...
  public CommandInterceptor createTransactionInterceptor() {
    if (transactionManager == null) {
      throw new ActivitiException("transactionManager is required property for SpringDmnEngineConfiguration, use " + StandaloneDmnEngineConfiguration.class.getName() + " otherwise");
    }
