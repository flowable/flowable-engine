...
public class CaseInstanceMigrationValidationResult {
    ...
    public CaseInstanceMigrationValidationResult addValidationMessage(String message) {
        validationMessages.add(message);
        return this;
    }

    public CaseInstanceMigrationValidationResult addValidationResult(CaseInstanceMigrationValidationResult result) {
        if (result != null) {
