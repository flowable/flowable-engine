...
public interface CaseInstanceMigrationDocumentBuilder {
    ...
    CaseInstanceMigrationDocumentBuilder addPlanItemMigrationMappings(List<PlanItemMigrationMapping> planItemMigrationMappings);

    CaseInstanceMigrationDocumentBuilder addPlanItemMigrationMapping(PlanItemMigrationMapping planItemMigrationMapping);
