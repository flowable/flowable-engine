...
public interface CaseInstanceMigrationBuilder {
    ...
    /**
     * Adds an plan item mapping to the case instance migration plan. Addition order is relevant and "auto-mapping" has priority. There can only be one mapping for a given "from" plan item.
     *
     * @param mapping Mapping for a specific plan item instance
     * @return Returns the builder
     * @see PlanItemMigrationMapping
     */
    CaseInstanceMigrationBuilder addActivityMigrationMapping(PlanItemMigrationMapping mapping);
