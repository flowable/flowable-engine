...
public class JPAVariableTest extends AbstractFlowableTestCase {
    ...
    public void testStoreJPAEntityAsVariable() {
        ...
        if (processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.AUDIT)) {
            HistoricVariableInstance historicVariableInstance = historyService.createHistoricVariableInstanceQuery().variableName("simpleEntityFieldAccess").singleResult();
