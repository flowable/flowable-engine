...
public class ParallelGatewayTest extends PluggableFlowableTestCase {
    ...
    public void testForkJoin() {
        ...
        org.flowable.task.service.Task task1 = tasks.get(0);
        assertEquals("Receive Payment", task1.getName());
        org.flowable.task.service.Task task2 = tasks.get(1);
    ...
    public void testUnbalancedForkJoin() {
        ...
        tasks = query.list();
        org.flowable.task.service.Task task3 = tasks.get(0);
        assertEquals(2, tasks.size());
        assertEquals("Task 3", task3.getName());
        org.flowable.task.service.Task task4 = tasks.get(1);
