...
public class SubTaskQueryTest extends PluggableFlowableTestCase {
    ...
    private List<String> generateTestSubTasks() throws Exception {
        ...
        org.flowable.task.service.Task rootTask1 = taskService.newTask();
        ...
        for (int i = 1; i <= 2; i++) {
            org.flowable.task.service.Task subtask = taskService.newTask();
        ...
        org.flowable.task.service.Task rootTask2 = taskService.newTask();
        ...
        org.flowable.task.service.Task rootTask3 = taskService.newTask();
