...
public class FormsResource {
  ...
  @RequestMapping(method = RequestMethod.GET, produces = "application/json")
    ...
    if (validFilter != null)
    {
      models = modelRepository.findByModelTypeAndFilter(AbstractModel.MODEL_TYPE_FORM_RDS, validFilter, ModelSort.NAME_ASC);

    }
    else
    {
      models = modelRepository.findByModelType(AbstractModel.MODEL_TYPE_FORM_RDS, ModelSort.NAME_ASC);
    }
