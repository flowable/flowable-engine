...
public abstract class FlowableListenerParser extends BaseChildElementParser {
    ...
    public void parseChildElement(XMLStreamReader xtr, BaseElement parentElement, BpmnModel model) throws Exception {
        ...
        if (StringUtils.isNotEmpty(xtr.getAttributeValue(null, ATTRIBUTE_LISTENER_CLASS))) {
            ...
            listener.setImplementation(xtr.getAttributeValue(null, ATTRIBUTE_LISTENER_TYPE));
            listener.setImplementationType(BpmnXMLConstants.ATTRIBUTE_LISTENER_TYPE);
        }
        ...
        if (ATTRIBUTE_LISTENER_TYPE_SCRIPT.equals(listener.getImplementation())) {
