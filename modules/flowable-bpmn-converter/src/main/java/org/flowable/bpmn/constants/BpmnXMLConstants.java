...
public interface BpmnXMLConstants {
    ...
    public static final String ATTRIBUTE_ASSIGNEE_VARIABLE_NAME = "assigneeVariableName";
    public static final String ATTRIBUTE_OWNER_VARIABLE_NAME = "ownerVariableName";
