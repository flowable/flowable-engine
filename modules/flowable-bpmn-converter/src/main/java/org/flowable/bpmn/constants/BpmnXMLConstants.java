...
public interface BpmnXMLConstants {
    ...
    public static final String ATTRIBUTE_MULTIINSTANCE_COLLECTION_FUNCTION_PREFIX = "prefix";
    public static final String ATTRIBUTE_MULTIINSTANCE_COLLECTION_FUNCTION_NAME = "name";
