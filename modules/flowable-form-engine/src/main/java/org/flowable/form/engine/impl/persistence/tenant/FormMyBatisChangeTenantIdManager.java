 ...
 */
package org.flowable.form.engine.impl.persistence.tenant;
 ...
 */
public class FormMyBatisChangeTenantIdManager implements ChangeTenantIdManager {

    protected final CommandExecutor commandExecutor;

    public FormMyBatisChangeTenantIdManager(CommandExecutor commandExecutor) {
    ...
    public ChangeTenantIdResult simulate(ChangeTenantIdRequest request) {
        return commandExecutor.execute(
                new SimulateChangeTenantIdCmd(request, ScopeTypes.FORM, Collections.singleton(FormChangeTenantIdEntityTypes.FORM_INSTANCES)));
    }

    @Override
    public ChangeTenantIdResult complete(ChangeTenantIdRequest request) {
        return commandExecutor.execute(
                new ExecuteChangeTenantIdCmd(request, ScopeTypes.FORM, Collections.singleton(FormChangeTenantIdEntityTypes.FORM_INSTANCES)));
    }
