...
/**
 * Methods for working with deployments.  Much of the actual work of {@link FormDefinitionDeployer} is
...
public class FormDefinitionDeploymentHelper  {
  ...
  public FormDefinitionEntity getMostRecentVersionOfForm(FormDefinitionEntity formDefinition) {
    ...
    FormDefinitionEntityManager formDefinitionEntityManager = 
        Context.getCommandContext().getFormEngineConfiguration().getFormDefinitionEntityManager();
  ...
  public FormDefinitionEntity getPersistedInstanceOfFormDefinition(FormDefinitionEntity formDefinition) {
    ...
    if (StringUtils.isEmpty(formDefinition.getDeploymentId())) {
      throw new ActivitiIllegalArgumentException("Provided form definition must have a deployment id.");
    }
