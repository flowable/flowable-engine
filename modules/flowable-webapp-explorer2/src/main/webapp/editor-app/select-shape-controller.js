...
activitiModule.controller('KisBpmShapeSelectionCtrl', [ '$rootScope', '$scope', '$timeout', '$translate','editorManager', function($rootScope, $scope, $timeout, $translate,editorManager) {
