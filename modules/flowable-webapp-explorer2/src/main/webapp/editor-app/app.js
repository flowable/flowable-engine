...
// Initialize routes
    ...
    .run(['$rootScope', '$timeout', '$modal', '$translate', '$location', '$window', '$http', '$q','editorManager',
        function ($rootScope, $timeout, $modal, $translate, $location, $window, $http, $q,editorManager) {
            ...
            $rootScope.$on('$includeContentLoaded', function (event) {
                if (!$rootScope.editorInitialized) {
                    ...
                    KISBPM.eventBus.addListener("ORYX-EDITOR-LOADED",function(){
            ...
            $rootScope.editorFactory.promise.then(function () {
                ...
                var eventMappings = [
                    ...
                    {oryxType: ORYX.CONFIG.EVENT_EDITOR_INIT_COMPLETED, kisBpmType:KISBPM.eventBus.EVENT_TYPE_EDITOR_READY},
                    {oryxType: ORYX.CONFIG.EVENT_PROPERTY_CHANGED, kisBpmType: KISBPM.eventBus.EVENT_TYPE_PROPERTY_VALUE_CHANGED}
                ];
                ...
                editorManager.registerOnEvent(ORYX.CONFIG.EVENT_SHAPEREMOVED, function (event) {
                ...
                //removed wrong assumption. The ORYX EDITOR IS NOT READY. There are setTimout Functions...
            });
            ...
            $http.get(KISBPM.URL.getStencilSet()).then(function (response) {
                ...
                return $http.get(KISBPM.URL.getModel(modelId));
            }).then(function (response) {
