...
/**
 * A meta {@link org.springframework.context.annotation.Conditional} annotation that checks if the Idm engine
 * should / can be activated.
 * <p>
 * By default the idm engine is activated when the {@link org.flowable.dmn.engine.DmnEngine} and
