...
drop index ACT_IDX_TIMER_JOB_CORRELATION_ID;
drop index ACT_IDX_TIMER_JOB_DUEDATE;
...
drop index ACT_IDX_SUSPENDED_JOB_CORRELATION_ID;
...
drop index ACT_IDX_DEADLETTER_JOB_CORRELATION_ID;
...
drop index ACT_IDX_EXTERNAL_JOB_EXCEPTION_STACK_ID;
drop index ACT_IDX_EXTERNAL_JOB_CUSTOM_VALUES_ID;
drop index ACT_IDX_EXTERNAL_JOB_CORRELATION_ID;
