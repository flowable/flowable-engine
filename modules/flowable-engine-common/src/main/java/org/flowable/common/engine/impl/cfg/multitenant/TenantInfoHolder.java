...
/**
 * Interface to be implemented when using the {@link org.flowable.engine.impl.cfg.multitenant.MultiSchemaMultiTenantProcessEngineConfiguration} and used to set/get the current user and tenant identifier.
 * 
