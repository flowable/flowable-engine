...
public class Delegate2 implements JavaDelegate {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Delegate2.class);
    ...
    public void execute(DelegateExecution execution) {
        ...
        LOGGER.info("the 'uuid' value retrieved from the ScopedCustomer#name property is '{}' in {}", this.statefulObject.getName(), getClass().getName());
    }
}
