 ...
 * @author Joram Barrez
 */
public class EventSubscriptionsByScopeDefinitionIdAndTypeAndNullScopeIdMatcher extends CachedEntityMatcherAdapter<EventSubscriptionEntity> {
    ...
    public boolean isRetained(EventSubscriptionEntity eventSubscriptionEntity, Object parameter) {
        ...
        return Objects.equals(scopeDefinitionId, eventSubscriptionEntity.getScopeDefinitionId())
            ...
            && eventSubscriptionEntity.getScopeId() == null;
    }
