...
public class MybatisTimerJobDataManager extends AbstractDataManager<TimerJobEntity> implements TimerJobDataManager {
    ...
    public long changeTenantIdTimerJobs(ChangeTenantIdRequest changeTenantIdRequest) {
        if (changeTenantIdRequest.isDryRun()) {
            return (long) getDbSqlSession().selectOne("countChangeTenantIdTimerJobs", changeTenantIdRequest);
        } else {
            return (long) getDbSqlSession().update("changeTenantIdTimerJobs", changeTenantIdRequest);
        }
    }
