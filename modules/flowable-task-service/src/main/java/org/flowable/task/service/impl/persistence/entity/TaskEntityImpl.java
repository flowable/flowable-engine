...
public class TaskEntityImpl extends AbstractTaskServiceVariableScopeEntity implements TaskEntity, CountingTaskEntity, Serializable {
    ...
    protected List<VariableInstanceEntity> loadVariableInstances() {
        return getVariableServiceConfiguration().getVariableInstanceEntityManager().findVariableInstancesByTaskId(id);
    }
    ...
    protected VariableInstanceEntity getSpecificVariable(String variableName) {
        ...
        VariableInstanceEntity variableInstance = getVariableServiceConfiguration().getVariableInstanceEntityManager().findVariableInstanceByTaskAndName(id, variableName);
    ...
    protected List<VariableInstanceEntity> getSpecificVariables(Collection<String> variableNames) {
        ...
        return getVariableServiceConfiguration().getVariableInstanceEntityManager().findVariableInstancesByTaskAndNames(id, variableNames);
    }
